...
export const ES_RECIPES: Record<string, string> = {
  ...
  // ---- 129 Smoked Paria & Aguaymanto Paste ----
  "Cook the aguaymanto with the lemon juice and a splash of water until it collapses completely.":
    "Cocine el aguaymanto con el jugo de limón y un chorro de agua hasta que se deshaga por completo.",
  "Push it through a sieve, weigh the pulp, and add three-quarters of that weight in sugar.":
    "Pásela por un colador, pese la pulpa y agregue tres cuartas partes de ese peso en azúcar.",
  "Cook the paste back down, stirring constantly, until it pulls away cleanly from the base of the pan.":
    "Vuelva a cocinar la pasta, revolviendo sin parar, hasta que se despegue limpiamente del fondo de la olla.",
  "Pour into a lined tray to a depth of 2 cm and leave it uncovered overnight to firm up.":
    "Vierta en una bandeja forrada hasta 2 cm de altura y déjela destapada toda la noche para que tome firmeza.",
  "Cut the paste into batons and the smoked paria into slabs of roughly the same thickness.":
    "Corte la pasta en bastones y el paria ahumado en lonjas de aproximadamente el mismo grosor.",
  "Board them together with the toasted pecans, and take the cheese out of the fridge an hour before service.":
    "Móntelos juntos en la tabla con las pecanas tostadas, y saque el queso de la refrigeradora una hora antes del servicio.",
  "The paste keeps for months made in season. Board it up on the morning of the event.":
    "La pasta dura meses si se hace en temporada. Arme la tabla la mañana del evento.",
  "Three hours on a board at room temperature, which is exactly how the cheese should be eaten.":
    "Tres horas en tabla a temperatura ambiente, que es exactamente como debe comerse el queso.",

  // ---- 130 Tarta de Queso, Lucuma ----
  "3 cakes, 36 portions": "3 tortas, 36 porciones",
  "Line the tins with baking parchment crumpled first, pushed in so it pleats well above the rim.":
    "Forre los moldes con papel manteca arrugado previamente, empujado de modo que se pliegue bien por encima del borde.",
  "Beat the cream cheese and sugar smooth before adding anything else, scraping the bowl twice.":
    "Bata el queso crema con el azúcar hasta que quede liso antes de agregar nada más, raspando el bol dos veces.",
  "Add the eggs two at a time on a low speed — beating air in now gives you a souffle that collapses.":
    "Agregue los huevos de dos en dos a velocidad baja — incorporar aire ahora da un suflé que se desploma.",
  "Fold in the cream, the lucuma pulp, the sifted flour and the salt until it is just uniform.":
    "Integre la crema, la pulpa de lúcuma, la harina tamizada y la sal solo hasta que quede uniforme.",
  "Bake at 210 °C for 50 to 55 minutes until the top is genuinely dark and the centre still moves as one.":
    "Hornee a 210 °C por 50 a 55 minutos hasta que la superficie esté realmente oscura y el centro todavía se mueva como una sola pieza.",
  "Cool completely in the tin and do not refrigerate — chilling is what turns a Basque cheesecake dense.":
    "Enfríe por completo en el molde y no refrigere — el frío es lo que vuelve densa una tarta vasca.",
  "Bake the day before and leave it out overnight. It is a better cake on day two.":
    "Hornee el día anterior y déjela fuera toda la noche. Es mejor torta al segundo día.",
  "All day at room temperature and it cuts to any headcount, which is what makes it good value.":
    "Todo el día a temperatura ambiente, y se corta para cualquier número de invitados, que es lo que la hace rentable.",
  "One oven takes three tins. Above 100 guests, bake across two days rather than crowding the shelves.":
    "Un horno acepta tres moldes. Por encima de 100 invitados, hornee en dos días en vez de saturar las bandejas.",

  // ---- 131 Causa de Trucha Ahumada ----
  "Boil the papa amarilla whole in salted water, then peel and pass it through a ricer while still hot.":
    "Hierva la papa amarilla entera en agua con sal, pélela y pásela por prensapuré todavía caliente.",
  "Work in the aji amarillo, lime juice, oil and salt while the potato is warm — cold potato will not take it up.":
    "Incorpore el ají amarillo, el jugo de limón, el aceite y la sal mientras la papa está tibia — la papa fría no los absorbe.",
  "Cool the mass completely before shaping, or the layers slump and the terrine loses its edges.":
    "Enfríe la masa por completo antes de armar, o las capas se hunden y la terrina pierde sus aristas.",
  "Flake the smoked trout and bind it with the soured cream and most of the dill, keeping the flakes visible.":
    "Desmenuce la trucha ahumada y lígela con la crema agria y casi todo el eneldo, dejando las láminas visibles.",
  "Layer potato, trout, potato in a lined tray, pressing each layer flat with an offset palette knife.":
    "Arme capas de papa, trucha y papa en una bandeja forrada, aplanando cada capa con una espátula acodada.",
  "Chill 3 hours, cut into squares with a hot wet knife, and finish each with a dill frond at the venue.":
    "Refrigere 3 horas, corte en cuadrados con un cuchillo caliente y mojado, y corone cada uno con una ramita de eneldo en el local.",
  "Build the terrine the day before and cut on the morning of service for the cleanest edges.":
    "Arme la terrina el día anterior y corte la mañana del servicio para lograr los bordes más limpios.",
  "Two hours out of the fridge. Set the tray over ice on a warm Lima afternoon.":
    "Dos horas fuera de la refrigeradora. Apoye la bandeja sobre hielo en una tarde calurosa de Lima.",

  // ---- 132 Causa de Haggis ----
  "Make the causa base exactly as for the trout version — riced hot potato, aji, lime, oil, seasoned hard.":
    "Haga la base de causa exactamente como en la versión de trucha — papa prensada en caliente, ají, limón, aceite y sazón fuerte.",
  "Cook the haggis mix through, then loosen it with the whisky and mustard until it is spreadable, not crumbly.":
    "Cocine bien la mezcla de haggis y aflójela con el whisky y la mostaza hasta que quede untable y no desmoronable.",
  "Let the haggis cool to room temperature; spread it hot and it melts the causa layer beneath it.":
    "Deje que el haggis baje a temperatura ambiente; untado caliente derrite la capa de causa que tiene debajo.",
  "Layer causa, haggis, causa, pressing firmly so the finished slab holds together under the knife.":
    "Arme capas de causa, haggis y causa, presionando con firmeza para que la placa final aguante el cuchillo.",
  "Chill at least 3 hours, then cut into squares with a hot wet knife wiped between every cut.":
    "Refrigere al menos 3 horas y corte en cuadrados con un cuchillo caliente y mojado, limpiándolo entre cada corte.",
  "Serve at cool room temperature — fridge-cold, the aji amarillo goes flat and reads as nothing.":
    "Sirva a temperatura ambiente fresca — helado de refrigeradora, el ají amarillo se apaga y no se lee.",
  "Build the day before. The whisky settles into the haggis and stops shouting overnight.":
    "Arme el día anterior. El whisky se asienta en el haggis y deja de gritar durante la noche.",
  "Two hours out of the fridge. This is the dish that explains the whole business in one bite.":
    "Dos horas fuera de la refrigeradora. Este es el plato que explica todo el negocio en un solo bocado.",

  // ---- 133 Anticuchos de Cordero, Muna ----
  "Blitz the aji panca, muna, garlic, vinegar, cumin and oil into a marinade thick enough to cling.":
    "Procese el ají panca, la muña, el ajo, el vinagre, el comino y el aceite hasta un adobo lo bastante espeso para adherirse.",
  "Marinate the lamb at least 8 hours — muna is a slower aromatic than rosemary and needs the time.":
    "Macere el cordero al menos 8 horas — la muña es un aromático más lento que el romero y necesita ese tiempo.",
  "Thread three cubes per skewer with the grain running the same way, so they cook at the same rate.":
    "Ensarte tres cubos por brocheta con la fibra orientada igual, para que se cocinen al mismo ritmo.",
  "Boil the papa nativa whole, then halve them and hold them warm to go alongside off the plancha.":
    "Hierva la papa nativa entera, pártala por la mitad y manténgala tibia para acompañar al salir de la plancha.",
  "Grill hard on a very hot plancha, 3 minutes a side, basting with the leftover marinade as you turn.":
    "Ase fuerte en una plancha muy caliente, 3 minutos por lado, bañando con el adobo sobrante al voltear.",
  "Rest the skewers 2 minutes on a warm tray before they go out, or the juice ends up on the guest.":
    "Repose las brochetas 2 minutos en una bandeja tibia antes de sacarlas, o el jugo termina sobre el invitado.",
  "Marinate and skewer the day before. The potatoes can be boiled in the morning and reheated.":
    "Macere y ensarte el día anterior. Las papas se pueden hervir en la mañana y recalentar.",
  "Grill to order. Skewers held more than 10 minutes go dry and there is no recovering them.":
    "Ase al momento. Las brochetas que esperan más de 10 minutos se secan y no hay forma de recuperarlas.",
  "A 1 m plancha turns out about 70 skewers an hour. Beyond that, add a grill, not a cook.":
    "Una plancha de 1 m saca unas 70 brochetas por hora. Más allá de eso, agregue una parrilla, no un cocinero.",

  // ---- 134 Ceviche de Corvina y Eneldo ----
  "Check the veda calendar before you buy — a closed season on corvina is law, and this dish has no substitute plan.":
    "Revise el calendario de vedas antes de comprar — la veda de la corvina es ley, y este plato no tiene plan de reemplazo.",
  "Cut the fish into 2 cm cubes and keep it on ice; warm fish cures unevenly and goes chalky at the edges.":
    "Corte el pescado en cubos de 2 cm y manténgalo sobre hielo; el pescado tibio se cura disparejo y se pone harinoso en los bordes.",
  "Squeeze the limes by hand and stop before the pith — a machine juicer makes the leche de tigre bitter.":
    "Exprima los limones a mano y pare antes de llegar a la parte blanca — un exprimidor mecánico amarga la leche de tigre.",
  "Blitz a handful of the fish with lime, aji limo, cucumber, dill stalks and salt to build the leche de tigre.":
    "Licúe un puñado del pescado con limón, ají limo, pepino, tallos de eneldo y sal para armar la leche de tigre.",
  "Pass it through a sieve, taste for salt and acid, and keep it ice-cold until the moment of service.":
    "Pásela por colador, pruebe sal y acidez, y manténgala helada hasta el momento del servicio.",
  "Dress the fish 4 minutes before it leaves the kitchen, add the sliced onion and dill fronds, and plate.":
    "Adere el pescado 4 minutos antes de que salga de la cocina, agregue la cebolla cortada y las ramitas de eneldo, y emplate.",
  "Cut the fish and make the leche de tigre the morning of. The two meet minutes before service.":
    "Corte el pescado y haga la leche de tigre la misma mañana. Los dos se encuentran minutos antes del servicio.",
  "Four minutes. This is a plated dish for a reason and it cannot be put on a buffet.":
    "Cuatro minutos. Es un plato emplatado por una razón y no se puede poner en un buffet.",

  // ---- 135 Tiradito de Trucha, Whisky ----
  "Freeze the fillets for 40 minutes before slicing — firm fish gives you thin slices, soft fish gives you shreds.":
    "Congele los filetes 40 minutos antes de cortar — el pescado firme da láminas finas, el blando da hilachas.",
  "Slice on the bias at about 3 mm and lay the slices flat and overlapping on chilled plates.":
    "Corte en diagonal a unos 3 mm y acomode las láminas planas y montadas sobre platos fríos.",
  "Warm the whisky briefly to take the raw spirit edge off, then cool it before it goes near the cream.":
    "Caliente el whisky brevemente para quitarle el filo del destilado crudo y enfríelo antes de acercarlo a la crema.",
  "Whisk the aji amarillo into the cream with the whisky and lime juice until it just coats a spoon.":
    "Integre el ají amarillo a la crema con el whisky y el jugo de limón hasta que apenas nape la cuchara.",
  "Spoon the sauce in a line across the fish rather than over it, so the guest sees both.":
    "Ponga la salsa en una línea que cruce el pescado en vez de cubrirlo, para que el invitado vea ambos.",
  "Finish with flaked salt and chives and send it out immediately — the lime keeps curing the fish on the plate.":
    "Termine con sal en escamas y cebollín y sáquelo de inmediato — el limón sigue curando el pescado en el plato.",
  "Make the sauce a day ahead. Slice the fish no more than an hour before service, kept on ice.":
    "Haga la salsa un día antes. Corte el pescado no más de una hora antes del servicio y manténgalo sobre hielo.",
  "Ten minutes plated. Slice and dress in rounds as the plates go out.":
    "Diez minutos una vez emplatado. Corte y adere por tandas a medida que salen los platos.",

  // ---- 136 Lomo Saltado, Dripping Chips ----
  "Blanch the chips in dripping at 140 °C until soft but pale, then drain and cool them completely on racks.":
    "Escalde las papas en grasa de res a 140 °C hasta que estén blandas pero pálidas, escurra y enfríelas por completo sobre rejillas.",
  "Season the beef and get the wok or plancha ferociously hot — a lukewarm pan stews the meat and floods it.":
    "Sazone la carne y ponga el wok o la plancha ferozmente caliente — una sartén tibia guisa la carne y la inunda.",
  "Sear the beef in small batches for barely a minute and pull it out while it is still rare in the middle.":
    "Selle la carne en tandas chicas por apenas un minuto y sáquela mientras siga roja al centro.",
  "Fry the onion hard for 30 seconds, add tomato, then deglaze with sillao and vinegar so it flames up.":
    "Fría la cebolla con fuerza por 30 segundos, agregue tomate y desglase con sillao y vinagre para que levante llama.",
  "Fry the chips a second time at 185 °C until crisp and deep gold — the dripping is what makes them taste Scottish.":
    "Fría las papas por segunda vez a 185 °C hasta que estén crocantes y doradas oscuras — la grasa de res es lo que las hace saber escocesas.",
  "Return the beef to the pan, toss with the chips off the heat, and serve within a minute of the toss.":
    "Devuelva la carne a la sartén, mézclela con las papas fuera del fuego y sirva dentro del minuto.",
  "First-fry the chips and cut everything the day before. The wok work happens only at the venue.":
    "Dé la primera fritura a las papas y corte todo el día anterior. El trabajo de wok ocurre solo en el local.",
  "Serve straight from the pan. Held ten minutes, the chips go soft and the dish is pointless.":
    "Sirva directo de la sartén. Diez minutos en espera y las papas se ablandan y el plato pierde sentido.",
  "One wok station does about 60 portions an hour. Two smaller pans beat one large one every time.":
    "Una estación de wok hace unas 60 porciones por hora. Dos sartenes chicas rinden más que una grande, siempre.",

  // ---- 137 Aji de Gallina, Cheddar Crumb ----
  "Poach the chickens with onion and bay, then shred the meat and keep 1.5 litres of the stock.":
    "Escalfe los pollos con cebolla y laurel, deshilache la carne y guarde 1,5 litros del caldo.",
  "Soak the bread in the evaporated milk for 15 minutes and blend it smooth with the pecans.":
    "Remoje el pan en la leche evaporada por 15 minutos y licúelo con las pecanas hasta que quede liso.",
  "Fry the aji amarillo paste in oil for a good 5 minutes until it darkens and loses its raw edge.":
    "Fría la pasta de ají amarillo en aceite por unos buenos 5 minutos hasta que oscurezca y pierda el filo crudo.",
  "Combine the paste, the bread cream and the stock, and cook it out until it holds a line on the spoon.":
    "Combine la pasta, la crema de pan y el caldo, y cocine hasta que sostenga una línea en la cuchara.",
  "Fold the chicken through, season hard, and spread it into gastronorm trays no deeper than 5 cm.":
    "Integre el pollo, sazone con fuerza y extienda en bandejas gastronorm de no más de 5 cm de alto.",
  "Rub the oats and cheddar into a crumb, scatter it over and bake at 190 °C for 25 minutes until dark gold.":
    "Arene la avena con el cheddar hasta formar un crumble, espárzalo encima y hornee a 190 °C por 25 minutos hasta dorado oscuro.",
  "Make the sauce and shred the meat 2 days ahead. Crumb and bake on the day of the event.":
    "Haga la salsa y deshilache la carne 2 días antes. El crumble y el horneado, el día del evento.",
  "Three hours in a chafing dish, which is the whole reason for the crumb — it stops a skin forming.":
    "Tres horas en chafing dish, que es toda la razón del crumble — impide que se forme una película.",

  // ---- 138 Huancaina de Paria y Pimienta ----
  "Boil the potatoes whole and unpeeled, then peel and slice them into thick rounds while warm.":
    "Hierva las papas enteras y con cáscara, luego pélelas y córtelas en rodajas gruesas en tibio.",
  "Fry the aji amarillo in oil until it darkens, and let it cool before it goes into the blender.":
    "Fría el ají amarillo en aceite hasta que oscurezca y déjelo enfriar antes de llevarlo a la licuadora.",
  "Blend the smoked paria, crackers, evaporated milk and cooled aji into a sauce that pours slowly.":
    "Licúe el paria ahumado, las galletas de soda, la leche evaporada y el ají frío hasta una salsa que caiga despacio.",
  "Crack the black pepper coarsely and stir it in at the end so the heat sits alongside the aji rather than under it.":
    "Muela la pimienta negra gruesa e incorpórela al final, para que su picor acompañe al ají en vez de quedar debajo.",
  "Nap the potato rounds with the sauce rather than drowning them; the potato has to still read as potato.":
    "Nape las rodajas de papa con la salsa en vez de ahogarlas; la papa tiene que seguir leyéndose como papa.",
  "Finish with olives and serve at cool room temperature, not fridge-cold.":
    "Termine con aceitunas y sirva a temperatura ambiente fresca, no helado de refrigeradora.",
  "Make the sauce 2 days ahead — it thickens, so slacken it with a little milk before serving.":
    "Haga la salsa 2 días antes — espesa, así que aflójela con un poco de leche antes de servir.",
  "Three hours at room temperature. The sauce forms a skin, so cover it until the moment it goes out.":
    "Tres horas a temperatura ambiente. La salsa forma película, así que manténgala tapada hasta el momento de salir.",

  // ---- 139 Rocoto Relleno, Morcilla ----
  "Cut the tops off the rocoto, hollow them out and keep the lids — they go back on for the bake.":
    "Corte la parte superior de los rocotos, vacíelos y guarde las tapas — vuelven a su sitio para el horneado.",
  "Boil the shells three times in fresh water with sugar and vinegar, discarding the water each time.":
    "Hierva las cáscaras tres veces en agua limpia con azúcar y vinagre, botando el agua cada vez.",
  "Taste a scrap of shell after the third boil; if it still takes your breath away, boil them once more.":
    "Pruebe un pedacito de cáscara después del tercer hervor; si todavía le quita el aliento, hiérvalos una vez más.",
  "Brown the beef, add the onion and aji panca, then fold the crumbled morcilla and the oats through off the heat.":
    "Dore la carne, agregue la cebolla y el ají panca, e integre la morcilla desmenuzada y la avena fuera del fuego.",
  "Fill the shells, cap each with a slice of paria and its own lid, and sit them upright in a deep tray.":
    "Rellene las cáscaras, corone cada una con una lámina de paria y su propia tapa, y párelas en una bandeja honda.",
  "Pour the evaporated milk around the base and bake at 180 °C for 40 minutes until the cheese is blistered.":
    "Vierta la leche evaporada alrededor de la base y hornee a 180 °C por 40 minutos hasta que el queso ampolle.",
  "Boil and stuff the shells the day before. Bake on site so they arrive at the table hot.":
    "Hierva y rellene las cáscaras el día anterior. Hornee en el local para que lleguen calientes a la mesa.",
  "Two hours in a chafing dish. The shells soften but the filling holds, which is the right trade.":
    "Dos horas en chafing dish. Las cáscaras se ablandan pero el relleno aguanta, que es el intercambio correcto.",

  // ---- 140 Ocopa de Ajo Silvestre ----
  "Boil the potatoes whole in well-salted water, then peel and slice them thick while they are still warm.":
    "Hierva las papas enteras en agua bien salada, luego pélelas y córtelas gruesas mientras siguen tibias.",
  "Toast the pecans in a dry pan until they smell nutty — untoasted, they make the sauce taste of nothing.":
    "Tueste las pecanas en sartén seca hasta que huelan a nuez — sin tostar, dejan la salsa sin sabor.",
  "Blanch the wild garlic leaf for 10 seconds and refresh it in ice water so the sauce stays green.":
    "Blanquee la hoja de ajo silvestre por 10 segundos y refrésquela en agua con hielo para que la salsa siga verde.",
  "Blend the huacatay, wild garlic, pecans, queso fresco, crackers and milk until completely smooth.":
    "Licúe el huacatay, el ajo silvestre, las pecanas, el queso fresco, las galletas de soda y la leche hasta que quede completamente liso.",
  "Season with salt and a squeeze of lime and check the consistency — it should coat, not flood.":
    "Sazone con sal y un chorro de limón y revise la consistencia — debe napar, no inundar.",
  "Nap the potatoes and serve at room temperature, dressing the trays only just before they go out.":
    "Nape las papas y sirva a temperatura ambiente, aderezando las bandejas justo antes de sacarlas.",
  "The sauce keeps 3 days but loses colour after one. Blend fresh on the morning of the event.":
    "La salsa dura 3 días pero pierde color al día siguiente. Licúela fresca la mañana del evento.",
  "Three hours at room temperature. Cover it, or the surface darkens within twenty minutes.":
    "Tres horas a temperatura ambiente. Tápela, o la superficie se oscurece en veinte minutos.",

  // ---- 141 Pastel de Choclo, Cordero y Avena ----
  "Brown the lamb hard in batches so it colours rather than steams, and drain off the excess fat.":
    "Dore el cordero con fuerza por tandas para que tome color en vez de cocinarse al vapor, y escurra el exceso de grasa.",
  "Sweat the onion with cumin and aji panca until sweet, then return the meat and stir the oats through.":
    "Sude la cebolla con comino y ají panca hasta que esté dulce, devuelva la carne e integre la avena.",
  "Add stock a ladle at a time until the oats swell and the mixture holds its shape on a spoon.":
    "Agregue caldo de a un cucharón hasta que la avena hinche y la mezcla sostenga su forma en la cuchara.",
  "Blitz the choclo kernels coarsely with the evaporated milk and a little butter into a rough, sweet paste.":
    "Licúe los granos de choclo grueso con la leche evaporada y un poco de mantequilla hasta una pasta rústica y dulce.",
  "Layer the meat into trays, lay the olives and egg over it, and spread the choclo paste right to the edges.":
    "Ponga la carne en bandejas, acomode las aceitunas y el huevo encima y extienda la pasta de choclo hasta los bordes.",
  "Dust with sugar and bake at 190 °C for 35 minutes until the top blisters and browns in patches.":
    "Espolvoree azúcar y hornee a 190 °C por 35 minutos hasta que la superficie ampolle y dore en manchas.",
  "Build the trays the day before and bake on site. It reheats better than almost anything here.":
    "Arme las bandejas el día anterior y hornee en el local. Se recalienta mejor que casi cualquier cosa de esta carta.",
  "Three hours in a chafing dish. The choclo lid stops it drying out the way mashed potato would.":
    "Tres horas en chafing dish. La tapa de choclo evita que se seque como lo haría un puré de papa.",

  // ---- 142 Empanada de Aji de Gallina y Puerro ----
  "60 empanadas": "60 empanadas",
  "Make the dough, rest it an hour in the fridge, and roll it to 3 mm — thicker and the filling ratio goes wrong.":
    "Haga la masa, déjela reposar una hora en la refrigeradora y estírela a 3 mm — más gruesa y la proporción de relleno se desequilibra.",
  "Sweat the leek in butter over a low heat for 20 minutes until it collapses and sweetens completely.":
    "Sude el poro en mantequilla a fuego bajo por 20 minutos hasta que se deshaga y endulce por completo.",
  "Fry the aji amarillo paste out properly, then add the soaked bread and cook to a thick, glossy base.":
    "Fría bien la pasta de ají amarillo, agregue el pan remojado y cocine hasta una base espesa y brillante.",
  "Fold the chicken and leek through and chill the filling hard — warm filling tears wet dough every time.":
    "Integre el pollo y el poro y refrigere bien el relleno — un relleno tibio rompe la masa húmeda siempre.",
  "Fill, fold and crimp with a repulgue, then chill the trays 20 minutes before they go in the oven.":
    "Rellene, doble y cierre con repulgue, y refrigere las bandejas 20 minutos antes de meterlas al horno.",
  "Egg-wash and bake at 200 °C for 22 minutes until deep gold, turning the trays once halfway.":
    "Pincele con huevo y hornee a 200 °C por 22 minutos hasta dorado oscuro, girando las bandejas una vez a mitad de cocción.",
  "Freeze filled and crimped, then bake from frozen at 190 °C for 28 minutes. Better than fresh-chilled.":
    "Congélelas rellenas y repulgadas, y hornee desde congelado a 190 °C por 28 minutos. Mejor que refrigeradas en fresco.",
  "Two hours warm, four at room temperature. They are designed to be eaten off a napkin.":
    "Dos horas tibias, cuatro a temperatura ambiente. Están diseñadas para comerse sobre una servilleta.",

  // ---- 143 Chupe de Corvina Ahumada ----
  "Smoke or buy the corvina smoked, then flake it and pick it over carefully for pin bones.":
    "Ahúme la corvina o cómprela ahumada, desmenúcela y revísela con cuidado para sacar las espinas.",
  "Build the base by frying onion, garlic and aji panca until dark, which is the aderezo everything sits on.":
    "Arme la base friendo cebolla, ajo y ají panca hasta que oscurezcan: ese es el aderezo sobre el que se apoya todo.",
  "Add the stock and the potatoes and simmer until the potatoes are done and starting to break at the edges.":
    "Agregue el caldo y las papas y cocine a fuego lento hasta que las papas estén listas y empiecen a deshacerse por los bordes.",
  "Add the choclo rounds for the last 8 minutes only, or they go tough and stringy in the bowl.":
    "Agregue las ruedas de choclo solo en los últimos 8 minutos, o se ponen duras y fibrosas en el plato.",
  "Pour in the milk and bring it to a bare simmer — boiled milk splits and there is no fixing it in the pot.":
    "Vierta la leche y llévela a un hervor apenas perceptible — la leche hervida se corta y no hay cómo arreglarla en la olla.",
  "Fold the smoked fish and the huacatay in off the heat and let it sit five minutes before serving.":
    "Integre el pescado ahumado y el huacatay fuera del fuego y deje reposar cinco minutos antes de servir.",
  "Make the base and cook the potatoes a day ahead. Milk and fish go in during the last ten minutes.":
    "Haga la base y cocine las papas un día antes. La leche y el pescado entran en los últimos diez minutos.",
  "Ninety minutes held below a simmer. Prawns have a legal closed season; this version does not.":
    "Noventa minutos mantenido por debajo del hervor. Los langostinos tienen veda legal; esta versión no.",

  // ---- 144 Arroz con Pato, Stout ----
  "Render the duck skin down in a dry pan and brown the joints hard in their own fat, then set them aside.":
    "Derrita la piel del pato en una sartén seca y dore las presas con fuerza en su propia grasa, luego resérvelas.",
  "Build the aderezo in the duck fat with onion, garlic and aji amarillo, cooking it until it is almost jammy.":
    "Arme el aderezo en la grasa de pato con cebolla, ajo y ají amarillo, cocinándolo hasta que quede casi como mermelada.",
  "Blitz the culantro with a little stock to a bright green liquor and hold it back until the very end.":
    "Licúe el culantro con un poco de caldo hasta un líquido verde intenso y guárdelo hasta el final.",
  "Braise the duck in the stout and stock for an hour until the meat pulls easily from the bone.":
    "Brasee el pato en la cerveza negra y el caldo por una hora hasta que la carne se despegue fácil del hueso.",
  "Lift the duck out, measure the liquor, and cook the rice in it with the choclo, covered and undisturbed.":
    "Retire el pato, mida el líquido y cocine el arroz en él junto con el choclo, tapado y sin moverlo.",
  "Fork the culantro liquor through the finished rice off the heat so it stays green, and sit the duck back on top.":
    "Integre el líquido de culantro al arroz terminado con un tenedor y fuera del fuego para que siga verde, y vuelva a colocar el pato encima.",
  "Braise the duck the day before. The rice must be cooked within an hour of service, not reheated.":
    "Brasee el pato el día anterior. El arroz debe cocinarse dentro de la hora previa al servicio, no recalentarse.",
  "One hour in a covered tray. Rice held longer goes claggy and the culantro browns off.":
    "Una hora en bandeja tapada. El arroz que espera más se apelmaza y el culantro se oscurece.",

  // ---- 145 Butifarra Escocesa ----
  "60 rolls": "60 panes",
  "Rub the pork leg with aji panca, garlic, cumin and salt and leave it overnight in the fridge.":
    "Frote la pierna de cerdo con ají panca, ajo, comino y sal y déjela toda la noche en la refrigeradora.",
  "Roast at 150 °C for three hours until a skewer meets no resistance, then cool it completely before slicing.":
    "Hornee a 150 °C por tres horas hasta que una brocheta no encuentre resistencia, y enfríe por completo antes de cortar.",
  "Slice it thin on a machine — hand-cut jamon del pais is too thick and the roll will not close.":
    "Córtelo fino en máquina — el jamón del país cortado a mano queda muy grueso y el pan no cierra.",
  "Cut the salsa criolla no more than an hour before service and dress it with lime and salt only.":
    "Corte la salsa criolla no más de una hora antes del servicio y adérela solo con limón y sal.",
  "Split the morning rolls, scrape a little mustard on the base, and lay the pork in loose folds.":
    "Abra los panes, unte un poco de mostaza en la base y acomode el cerdo en pliegues sueltos.",
  "Top with drained salsa criolla and close; wet criolla will turn the roll to paste within twenty minutes.":
    "Corone con salsa criolla escurrida y cierre; una criolla mojada convierte el pan en pasta en veinte minutos.",
  "Roast and slice the pork the day before. Build the rolls no more than an hour before service.":
    "Hornee y corte el cerdo el día anterior. Arme los panes no más de una hora antes del servicio.",
  "One hour built. Beyond that the roll goes soggy, so build in rounds as trays go out.":
    "Una hora una vez armado. Más allá el pan se aguada, así que arme por tandas a medida que salen las bandejas.",

  // ---- 146 Suspiro Limeno, Whisky ----
  "40 glasses": "40 copas",
  "Cook the two milks together over a low heat, stirring constantly, until the manjar blanco pulls from the pan.":
    "Cocine las dos leches juntas a fuego bajo, revolviendo sin parar, hasta que el manjar blanco se despegue de la olla.",
  "Take it off the heat and beat the yolks in one at a time so they thicken it without scrambling.":
    "Retire del fuego e integre las yemas de a una batiendo, para que espesen sin cuajarse.",
  "Cool the manjar completely and spoon it into glasses to just under half full.":
    "Enfríe el manjar por completo y repártalo en copas hasta un poco menos de la mitad.",
  "Boil the sugar with a little water to 118 °C, then pour it onto the whipping whites in a thin steady thread.":
    "Hierva el azúcar con un poco de agua hasta 118 °C y viértalo sobre las claras batiéndose en un hilo fino y constante.",
  "Beat the meringue to stiff and glossy, then fold the whisky in at the very end — heat would cook it off.":
    "Bata el merengue a punto firme y brillante e integre el whisky al final — el calor lo evaporaría.",
  "Pipe the meringue over the manjar, dust with cinnamon, and keep the glasses cool until service.":
    "Ponga el merengue con manga sobre el manjar, espolvoree canela y mantenga las copas frescas hasta el servicio.",
  "Make the manjar 3 days ahead. Whip the meringue on the day; it weeps by the second morning.":
    "Haga el manjar 3 días antes. Bata el merengue el mismo día; para la segunda mañana ya llora.",
  "Four hours at cool room temperature. Direct sun on a Lima terrace collapses the meringue fast.":
    "Cuatro horas a temperatura ambiente fresca. El sol directo en una terraza limeña baja el merengue rápido.",

  // ---- 147 Picarones, Marmalade Syrup ----
  "Boil the camote and zapallo separately until soft, then pass both and weigh the puree before mixing.":
    "Hierva el camote y el zapallo por separado hasta que estén blandos, pase ambos y pese el puré antes de mezclar.",
  "Mix the puree with the flour and activated yeast to a wet, sticky batter and prove it 90 minutes.":
    "Mezcle el puré con la harina y la levadura activada hasta una masa húmeda y pegajosa y déjela leudar 90 minutos.",
  "Melt the chancaca with the marmalade, orange peel, fig leaf and anise into a syrup and pass it through a sieve.":
    "Derrita la chancaca con la mermelada, la cáscara de naranja, la hoja de higo y el anís hasta hacer una miel y pásela por colador.",
  "Get the oil to 180 °C and check it with a scrap of batter before the first real ring goes in.":
    "Lleve el aceite a 180 °C y pruébelo con un pedacito de masa antes de echar el primer aro de verdad.",
  "Shape each ring with a wet hand and a thumb through the middle, dropping it straight into the oil.":
    "Forme cada aro con la mano mojada y el pulgar atravesando el centro, echándolo directo al aceite.",
  "Fry 90 seconds a side, drain briefly, and pour the warm syrup over as it goes to the guest.":
    "Fría 90 segundos por lado, escurra brevemente y bañe con la miel tibia justo cuando va al invitado.",
  "The syrup keeps for weeks. The batter must be proved on the day and used within four hours.":
    "La miel dura semanas. La masa debe leudarse el mismo día y usarse dentro de cuatro horas.",
  "Fry to order. A picaron that has sat five minutes is a doughnut, and not a good one.":
    "Fría al momento. Un picarón que lleva cinco minutos esperando es una dona, y no una buena.",
  "One fryer does about 90 rings an hour. This is a queue-forming station, so staff it accordingly.":
    "Una freidora hace unos 90 aros por hora. Es una estación que genera cola, así que dótela de personal en consecuencia.",

  // ---- 148 Alfajores de Lucuma y Mantequilla ----
  "80 alfajores": "80 alfajores",
  "Beat the butter and icing sugar only until smooth — creaming air in gives you a biscuit that spreads.":
    "Bata la mantequilla con el azúcar en polvo solo hasta que quede lisa — incorporar aire da una galleta que se expande.",
  "Work in both flours by hand to shortbread proportions, which is what makes this version hold its snap.":
    "Incorpore las dos harinas a mano en proporciones de shortbread, que es lo que hace que esta versión mantenga su quiebre.",
  "Roll to 5 mm between parchment, cut discs, and chill them a full 30 minutes before baking.":
    "Estire a 5 mm entre papel manteca, corte discos y refrigérelos 30 minutos completos antes de hornear.",
  "Bake at 160 °C for 13 to 15 minutes until barely coloured; browning kills the texture you are after.":
    "Hornee a 160 °C por 13 a 15 minutos hasta que apenas tomen color; dorarlos mata la textura que busca.",
  "Beat the lucuma pulp into the manjar blanco, which cuts the sweetness and stiffens it for piping.":
    "Integre la pulpa de lúcuma al manjar blanco: corta el dulzor y lo endurece para trabajar con manga.",
  "Sandwich the cooled discs, roll the edges in more lucuma manjar if you like, and dust with icing sugar.":
    "Arme el sándwich con los discos fríos, pase los bordes por más manjar de lúcuma si quiere y espolvoree azúcar en polvo.",
  "Bake the discs up to a week ahead and sandwich within 24 hours of service.":
    "Hornee los discos hasta una semana antes y arme los sándwiches dentro de las 24 horas previas al servicio.",
  "Two days sandwiched before the biscuit softens. Undipped discs keep a week in a sealed tin.":
    "Dos días armados antes de que la galleta se ablande. Los discos sin rellenar duran una semana en tarro hermético.",

  // ---- 149 Turron de Dona Pepa, Avena ----
  "Rub the butter into the flour and oatmeal, then bring it together with the yolks and a little anise water.":
    "Arene la mantequilla con la harina y la avena, y una la masa con las yemas y un poco de agua de anís.",
  "Roll the dough into finger-thick sticks and lay them in tight rows so they bake into a slab.":
    "Forme palitos del grosor de un dedo y acomódelos en filas apretadas para que horneen como una placa.",
  "Bake at 170 °C for 25 minutes until dry and firm all the way through, then cool completely.":
    "Hornee a 170 °C por 25 minutos hasta que estén secos y firmes de lado a lado, y enfríe por completo.",
  "Simmer the chancaca with ginger, cloves, orange peel, quince and fig leaf to a syrup that threads off a spoon.":
    "Cocine la chancaca a fuego lento con kion, clavo, cáscara de naranja, membrillo y hoja de higo hasta una miel que hile desde la cuchara.",
  "Layer the sticks in a tray, pouring syrup over each layer and crossing the direction as you build.":
    "Acomode los palitos en capas en una bandeja, bañando cada capa con miel y cruzando la dirección conforme arma.",
  "Leave overnight for the syrup to soak in, then cut into squares with a heavy oiled knife.":
    "Deje toda la noche para que la miel penetre, y corte en cuadrados con un cuchillo pesado y aceitado.",
  "Bake the sticks a week ahead. Assemble and syrup two days before service so it sets properly.":
    "Hornee los palitos una semana antes. Arme y almibare dos días antes del servicio para que cuaje bien.",
  "A week at room temperature, wrapped. This is an October product and it keeps like one.":
    "Una semana a temperatura ambiente, envuelto. Es un producto de octubre y se conserva como tal.",

  // ---- 150 Chicha Morada Trifle ----
  "Boil the maiz morado with pineapple skin, quince, cinnamon and clove for 40 minutes to make the chicha.":
    "Hierva el maíz morado con cáscara de piña, membrillo, canela y clavo por 40 minutos para hacer la chicha.",
  "Strain it, sweeten to taste and sharpen it with lime — under-acidic chicha sets into a bland jelly.":
    "Cuélela, endulce al gusto y acentúela con limón — una chicha poco ácida cuaja en una gelatina sosa.",
  "Soften the gelatine, dissolve it into a portion of the warm chicha, then combine and cool to room temperature.":
    "Hidrate la gelatina, disuélvala en una parte de la chicha tibia, combine y enfríe a temperatura ambiente.",
  "Line the trifle bowls with sponge fingers and pour the cooled chicha over, filling to two-thirds.":
    "Forre los boles con bizcotelas y vierta la chicha fría encima, llenando hasta dos tercios.",
  "Set for at least 4 hours before the cream goes on; a warm jelly and whipped cream make a pink mess.":
    "Deje cuajar al menos 4 horas antes de poner la crema; una gelatina tibia y crema batida dan un desastre rosado.",
  "Whip the cream to soft peaks, spoon it over the set jelly and top with toasted oatmeal at the venue.":
    "Bata la crema a picos suaves, repártala sobre la gelatina cuajada y corone con avena tostada en el local.",
  "Make the chicha and set the jellies 2 days ahead. Cream and oatmeal go on at the venue.":
    "Haga la chicha y cuaje las gelatinas 2 días antes. La crema y la avena van en el local.",
  "Two hours out of the fridge before the jelly softens. The oatmeal goes on last or it goes soft.":
    "Dos horas fuera de la refrigeradora antes de que la gelatina se ablande. La avena va al final o se ablanda.",

  // ---- 151 Torta Tres Leches, Whisky ----
  "36 portions": "36 porciones",
  "Whisk the yolks with half the sugar to a thick ribbon, then fold in the sifted flour by hand.":
    "Bata las yemas con la mitad del azúcar hasta punto letra, e integre la harina tamizada a mano.",
  "Beat the whites to soft peak with the rest of the sugar and fold them through in three additions.":
    "Bata las claras a picos suaves con el resto del azúcar e intégrelas en tres adiciones.",
  "Bake at 175 °C for 30 minutes; the sponge must be dry, because a wet one collapses when soaked.":
    "Hornee a 175 °C por 30 minutos; el bizcocho debe quedar seco, porque uno húmedo se desploma al remojarse.",
  "Cool completely, then dock the whole surface with a skewer so the soak reaches the base.":
    "Enfríe por completo y pinche toda la superficie con una brocheta para que el remojo llegue a la base.",
  "Mix the three milks with the whisky and pour it over cold sponge in three passes, 20 minutes apart.":
    "Mezcle las tres leches con el whisky y viértalas sobre el bizcocho frío en tres pasadas, con 20 minutos entre cada una.",
  "Chill overnight and finish with burnt sugar at the venue, not before, or the top goes to syrup.":
    "Refrigere toda la noche y termine con azúcar quemada en el local, no antes, o la superficie se vuelve almíbar.",
  "Bake two days ahead, soak the day before. It is a better cake on day two than on day one.":
    "Hornee dos días antes y remoje el día anterior. Es mejor torta al segundo día que al primero.",
  "Needs refrigeration; two hours out at a Lima event. The soak makes it heavy, so cut small.":
    "Necesita refrigeración; dos horas fuera en un evento limeño. El remojo la vuelve pesada, así que corte porciones chicas.",
  "Soak in three passes at any size. Poured in one go it runs off the top and floods the tray.":
    "Remoje en tres pasadas sea cual sea el tamaño. Vertido de golpe se escurre por encima e inunda la bandeja.",

  // ---- 152 Lucuma Victoria Sponge ----
  "Cream the butter and sugar for a full 5 minutes until it is pale and noticeably lighter.":
    "Cremee la mantequilla y el azúcar por 5 minutos completos hasta que palidezca y se note más ligera.",
  "Add the eggs one at a time with a spoonful of the flour to stop the batter splitting.":
    "Agregue los huevos de a uno con una cucharada de la harina para evitar que la masa se corte.",
  "Fold in the remaining flour in two additions and stop the moment no dry flour shows.":
    "Integre el resto de la harina en dos adiciones y pare en el momento en que no quede harina seca a la vista.",
  "Divide between four lined tins and bake at 180 °C for 25 to 30 minutes until springy.":
    "Reparta en cuatro moldes forrados y hornee a 180 °C por 25 a 30 minutos hasta que estén esponjosos al tacto.",
  "Beat the lucuma pulp with a third of the cream to a curd, then whip the rest to soft peak.":
    "Bata la pulpa de lúcuma con un tercio de la crema hasta una crema espesa, y bata el resto a picos suaves.",
  "Sandwich cold sponge with lucuma curd first, cream on top of it, and dust with icing sugar.":
    "Arme el bizcocho frío poniendo primero la crema de lúcuma, encima la crema batida, y espolvoree azúcar en polvo.",
  "Bake the day before and keep the sponges wrapped. Fill on the morning of the event.":
    "Hornee el día anterior y guarde los bizcochos envueltos. Rellene la mañana del evento.",
  "Four hours filled at room temperature. Filled the night before, the sponge goes damp.":
    "Cuatro horas rellena a temperatura ambiente. Rellenada la noche anterior, el bizcocho se humedece.",

  // ---- 153 Cacao Celebration Cake ----
  "2 cakes, 40 slices": "2 tortas, 40 porciones",
  "Melt 600 g of the chocolate with a third of the butter and let it cool to blood heat.":
    "Derrita 600 g del chocolate con un tercio de la mantequilla y déjelo enfriar a temperatura corporal.",
  "Cream the remaining butter with the caster sugar, then beat in the eggs two at a time.":
    "Cremee el resto de la mantequilla con el azúcar fina y agregue los huevos de dos en dos batiendo.",
  "Fold in the cooled chocolate, then the flour, and stop before the batter goes tight.":
    "Integre el chocolate frío y luego la harina, y pare antes de que la masa se apriete.",
  "Bake in four lined tins at 170 °C for 40 to 45 minutes; a skewer should come out with crumbs, not clean.":
    "Hornee en cuatro moldes forrados a 170 °C por 40 a 45 minutos; la brocheta debe salir con migas, no limpia.",
  "Make the buttercream by beating soft butter with melted chancaca and the remaining chocolate.":
    "Haga el buttercream batiendo mantequilla pomada con chancaca derretida y el chocolate restante.",
  "Level the layers with a serrated knife, stack with buttercream, and press cacao nibs round the base.":
    "Empareje las capas con cuchillo de sierra, apílelas con buttercream y presione nibs de cacao alrededor de la base.",
  "Bake two days ahead. Fill and coat the day before; a coated cake travels far better.":
    "Hornee dos días antes. Rellene y cubra el día anterior; una torta cubierta viaja mucho mejor.",
  "All day at room temperature. Above 26 °C the buttercream slips — transport it cold.":
    "Todo el día a temperatura ambiente. Por encima de 26 °C el buttercream se desliza — transpórtela en frío.",
  "Four tins is one oven. Above 80 slices, bake across two days rather than crowding shelves.":
    "Cuatro moldes son un horno. Por encima de 80 porciones, hornee en dos días en vez de saturar las bandejas.",

  // ---- 154 Carrot & Kiwicha Cake ----
  "Toast the kiwicha dry until it pops, then cool it — untoasted it stays hard in the crumb.":
    "Tueste la kiwicha en seco hasta que reviente y enfríela — sin tostar queda dura dentro de la miga.",
  "Grate the carrot on the coarse side; fine grating turns to water and the cake sinks.":
    "Ralle la zanahoria por el lado grueso; el rallado fino se vuelve agua y la torta se hunde.",
  "Whisk the oil, sugar and eggs, then fold in the flour, cinnamon, kiwicha and carrot.":
    "Bata el aceite, el azúcar y los huevos, e integre la harina, la canela, la kiwicha y la zanahoria.",
  "Bake at 175 °C for 35 to 40 minutes until the top springs back and the edges pull away.":
    "Hornee a 175 °C por 35 a 40 minutos hasta que la superficie vuelva al tacto y los bordes se despeguen.",
  "Beat the queso fresco smooth with icing sugar and a little lime zest for the frosting.":
    "Bata el queso fresco hasta que quede liso con azúcar en polvo y un poco de ralladura de limón para el frosting.",
  "Frost only once the cake is stone cold, or the queso fresco slides off the top.":
    "Cubra solo cuando la torta esté completamente fría, o el queso fresco se resbala por encima.",
  "Bake 2 days ahead — an oil-based cake keeps far better than a butter one. Frost on the day.":
    "Hornee 2 días antes — una torta a base de aceite se conserva mucho mejor que una de mantequilla. Cubra el mismo día.",
  "Frosted, keep it cool and serve within four hours. Unfrosted it holds for days.":
    "Ya cubierta, manténgala fresca y sírvala dentro de cuatro horas. Sin cubrir aguanta días.",

  // ---- 155 Coffee & Pecan Cake ----
  "Brew the coffee at double strength and cool it — hot coffee cooks the egg in the batter.":
    "Prepare el café al doble de concentración y enfríelo — el café caliente cuaja el huevo de la masa.",
  "Toast the pecans and chop them, keeping a third back whole for the top.":
    "Tueste las pecanas y píquelas, reservando un tercio enteras para la superficie.",
  "Cream the butter and sugar, add the eggs one at a time, then half the coffee and the flour.":
    "Cremee la mantequilla y el azúcar, agregue los huevos de a uno y luego la mitad del café y la harina.",
  "Fold the chopped pecans through and bake at 180 °C for 28 to 30 minutes.":
    "Integre las pecanas picadas y hornee a 180 °C por 28 a 30 minutos.",
  "Beat the remaining coffee into butter and icing sugar for the buttercream.":
    "Integre el café restante batiéndolo con mantequilla y azúcar en polvo para el buttercream.",
  "Sandwich and top the cold sponges, then set the whole pecans round the edge.":
    "Rellene y cubra los bizcochos fríos, y coloque las pecanas enteras alrededor del borde.",
  "Bake the day before. The coffee flavour deepens overnight and the crumb settles.":
    "Hornee el día anterior. El sabor del café se profundiza durante la noche y la miga se asienta.",
  "All day at room temperature. This is the most forgiving cake on the sheet.":
    "Todo el día a temperatura ambiente. Es la torta más indulgente de toda la hoja.",

  // ---- 156 Torta Helada de Aguaymanto ----
  "Rub the butter into the oats, flour and a little sugar and press it into lined trays.":
    "Arene la mantequilla con la avena, la harina y un poco de azúcar y presione en bandejas forradas.",
  "Bake the oat base at 175 °C for 20 minutes until it smells nutty, then cool it flat.":
    "Hornee la base de avena a 175 °C por 20 minutos hasta que huela a nuez y enfríela plana.",
  "Cook the aguaymanto with the sugar until it collapses, then pass half and keep half whole.":
    "Cocine el aguaymanto con el azúcar hasta que se deshaga, pase la mitad por colador y deje la otra mitad entera.",
  "Soften the gelatine, dissolve it into the warm fruit, and cool the mixture to room temperature.":
    "Hidrate la gelatina, disuélvala en la fruta tibia y enfríe la mezcla a temperatura ambiente.",
  "Whip the cream to soft peak and fold a third of the fruit through it for the middle layer.":
    "Bata la crema a picos suaves e integre un tercio de la fruta para la capa del medio.",
  "Layer cream over base, then clear fruit jelly on top, and set 4 hours before cutting.":
    "Ponga la crema sobre la base, luego la gelatina de fruta limpia encima, y deje cuajar 4 horas antes de cortar.",
  "Build 2 days ahead. The layers set firmer overnight and cut far more cleanly.":
    "Arme 2 días antes. Las capas cuajan más firmes durante la noche y se cortan mucho más limpias.",
  "Needs refrigeration. Two hours out before the jelly softens at the edges.":
    "Necesita refrigeración. Dos horas fuera antes de que la gelatina se ablande por los bordes.",

  // ---- 157 Cacao & Olive Oil Cake (vegan) ----
  "Sift the flour, sugar, cocoa and bicarbonate together — no egg means no second chance to fix lumps.":
    "Tamice juntos la harina, el azúcar, el cacao y el bicarbonato — sin huevo no hay segunda oportunidad para arreglar grumos.",
  "Whisk the olive oil into the chicha morada and pour it into the dry ingredients.":
    "Integre el aceite de oliva a la chicha morada batiendo y viértalo sobre los ingredientes secos.",
  "Add the vinegar last and mix for 30 seconds only; the acid and bicarbonate start working immediately.":
    "Agregue el vinagre al final y mezcle solo 30 segundos; el ácido y el bicarbonato empiezan a actuar de inmediato.",
  "Get it into the tins and into the oven straight away, or the rise is spent before it bakes.":
    "Llévelo a los moldes y al horno de inmediato, o el levantado se gasta antes de hornearse.",
  "Bake at 180 °C for 32 to 35 minutes until a skewer comes out clean.":
    "Hornee a 180 °C por 32 a 35 minutos hasta que una brocheta salga limpia.",
  "Cool in the tin — a vegan sponge is fragile hot and firms up considerably as it cools.":
    "Enfríe en el molde — un bizcocho vegano es frágil en caliente y toma bastante firmeza al enfriar.",
  "Bake the day before; oil-based sponges keep better than butter ones and stay moist for three days.":
    "Hornee el día anterior; los bizcochos a base de aceite se conservan mejor que los de mantequilla y siguen húmedos tres días.",
  "All day at room temperature. No dairy and no egg, so it is also the safest cake in a hot van.":
    "Todo el día a temperatura ambiente. Sin lácteos ni huevo, así que también es la torta más segura en una camioneta caliente.",
  "Mix in batches no larger than two tins. The raising is chemical and it does not wait.":
    "Mezcle en tandas de no más de dos moldes. El leudado es químico y no espera.",

  // ---- 158 Quinoa & Almond Torte ----
  "2 tortes, 24 slices": "2 tortas, 24 porciones",
  "Keep this away from every wheat surface in the kitchen — for a coeliac guest that is the whole point.":
    "Manténgala lejos de toda superficie con trigo de la cocina — para un invitado celíaco ese es todo el punto.",
  "Whisk the yolks with two-thirds of the sugar until pale, then fold in the almonds and quinoa flour.":
    "Bata las yemas con dos tercios del azúcar hasta que palidezcan e integre las almendras y la harina de quinua.",
  "Beat the whites to soft peak with the remaining sugar; they are the only lift this cake gets.":
    "Bata las claras a picos suaves con el azúcar restante; son el único levantado que tiene esta torta.",
  "Fold the whites through in three additions, losing as little air as you can manage.":
    "Integre las claras en tres adiciones, perdiendo la menor cantidad de aire posible.",
  "Fold in the melted butter and lemon zest last, then bake at 170 °C for 38 to 40 minutes.":
    "Integre al final la mantequilla derretida y la ralladura de limón, y hornee a 170 °C por 38 a 40 minutos.",
  "Scatter flaked almonds over while warm so they stick, and cool completely in the tin.":
    "Esparza almendras laminadas en tibio para que se adhieran, y enfríe por completo en el molde.",
  "Bake 2 days ahead. It is denser and better on the second day.":
    "Hornee 2 días antes. Es más densa y mejor al segundo día.",
  "All day at room temperature. Wheat-free by construction, not by substitution.":
    "Todo el día a temperatura ambiente. Sin trigo por construcción, no por sustitución.",

  // ---- 159 Chirimoya Pavlova ----
  "Wipe the bowl with lemon and dry it — a trace of fat and the whites will not whip.":
    "Limpie el bol con limón y séquelo — con un rastro de grasa las claras no montan.",
  "Beat the whites to soft peak, then add the sugar a spoonful at a time over a full 8 minutes.":
    "Bata las claras a picos suaves y agregue el azúcar de a una cucharada a lo largo de 8 minutos completos.",
  "Fold in the cornflour and vinegar at the end; they give the marshmallow centre.":
    "Integre el chuño y el vinagre al final; son los que dan el centro tipo malvavisco.",
  "Bake at 110 °C for 2 hours, then switch the oven off and leave them in it to cool completely.":
    "Hornee a 110 °C por 2 horas, apague el horno y déjelas dentro hasta que enfríen por completo.",
  "Scoop the chirimoya at the last moment and pick the seeds out — every one of them.":
    "Saque la pulpa de la chirimoya al último momento y retire las pepas — todas y cada una.",
  "Whip the cream to soft peak, pile it on, and top with chirimoya and lime at the venue.":
    "Bata la crema a picos suaves, móntela encima y corone con chirimoya y limón en el local.",
  "Bake the meringue 2 days ahead and keep it sealed and dry. Assemble at the venue only.":
    "Hornee el merengue 2 días antes y manténgalo sellado y seco. Arme únicamente en el local.",
  "Twenty minutes assembled. Lima humidity is the enemy — keep the shells boxed until the last moment.":
    "Veinte minutos una vez armada. La humedad de Lima es el enemigo — mantenga los merengues encajados hasta el último momento.",

  // ---- 160 Banana & Chancaca Loaf ----
  "3 loaves, 30 slices": "3 kekes, 30 porciones",
  "Use bananas that are black — anything less and the loaf tastes of flour rather than fruit.":
    "Use plátanos negros — con menos que eso el keke sabe a harina y no a fruta.",
  "Melt two-thirds of the chancaca with a splash of water and let it cool before it meets the eggs.":
    "Derrita dos tercios de la chancaca con un chorro de agua y déjela enfriar antes de que toque los huevos.",
  "Mash the bananas roughly, leaving lumps; a puree gives you a dense wet loaf.":
    "Aplaste los plátanos grueso, dejando grumos; un puré da un keke denso y húmedo.",
  "Fold everything together in as few strokes as possible and get it into lined tins.":
    "Integre todo con la menor cantidad de movimientos posible y llévelo a moldes forrados.",
  "Bake at 170 °C for 50 to 55 minutes, covering the tops with foil at 35 minutes if they colour fast.":
    "Hornee a 170 °C por 50 a 55 minutos, cubriendo la superficie con papel aluminio a los 35 minutos si dora rápido.",
  "Melt the remaining chancaca and brush it over while the loaves are still hot in the tin.":
    "Derrita la chancaca restante y pincélela mientras los kekes siguen calientes en el molde.",
  "Bake 3 days ahead. It improves for two of them and then holds.":
    "Hornee 3 días antes. Mejora durante dos de ellos y luego se mantiene.",
  "Days, wrapped. The best-keeping cake here and the cheapest to make.":
    "Días, envuelto. La torta que mejor se conserva de esta carta y la más barata de hacer.",

  // ---- 161 Maracuya Curd Cake ----
  "Make the curd first: cook the maracuya juice, yolks, sugar and a third of the butter to a thick coat.":
    "Haga primero la crema: cocine el jugo de maracuyá, las yemas, el azúcar y un tercio de la mantequilla hasta que nape espeso.",
  "Pass the curd, press cling film onto the surface and chill it hard — a warm curd will not hold in a cake.":
    "Cuele la crema, presione film sobre la superficie y refrigere bien — una crema tibia no se sostiene dentro de una torta.",
  "Cream the remaining butter with the caster sugar, beat in the whole eggs, fold in the flour.":
    "Cremee el resto de la mantequilla con el azúcar fina, incorpore los huevos enteros batiendo e integre la harina.",
  "Bake at 180 °C for 30 to 35 minutes and cool the sponges completely in the tins.":
    "Hornee a 180 °C por 30 a 35 minutos y enfríe los bizcochos por completo en los moldes.",
  "Split each sponge and fill generously with the cold curd — this is what people came for.":
    "Parta cada bizcocho y rellene con generosidad con la crema fría — es a lo que la gente vino.",
  "Glaze the top with icing sugar slackened with a little more maracuya juice, and let it set.":
    "Glasee la superficie con azúcar en polvo aflojada con un poco más de jugo de maracuyá y deje cuajar.",
  "Curd keeps a week refrigerated. Bake the day before, fill and glaze on the morning.":
    "La crema dura una semana refrigerada. Hornee el día anterior, rellene y glasee en la mañana.",
  "Six hours at room temperature. The glaze holds colour better than a lemon one does.":
    "Seis horas a temperatura ambiente. El glaseado mantiene el color mejor que uno de limón.",

  // ---- 162 Sticky Ginger Parkin ----
  "Melt the chancaca and butter together gently until no grain remains, then take it off the heat.":
    "Derrita la chancaca y la mantequilla juntas suavemente hasta que no quede ni un grano, y retire del fuego.",
  "Mix the oatmeal, flour, ginger and a pinch of salt, and pour the warm chancaca mixture in.":
    "Mezcle la avena, la harina, el kion y una pizca de sal, y vierta encima la mezcla tibia de chancaca.",
  "Beat the eggs into the milk and add it last, to a batter that pours rather than drops.":
    "Bata los huevos con la leche y agréguelos al final, hasta una masa que se vierta en vez de caer a cucharadas.",
  "Bake at 150 °C for a full hour — parkin is baked low and slow or the outside sets before the middle.":
    "Hornee a 150 °C por una hora completa — el parkin se hornea bajo y lento o el exterior cuaja antes que el centro.",
  "Cool completely in the tin before you attempt to cut it. Warm parkin tears.":
    "Enfríe por completo en el molde antes de intentar cortarlo. El parkin tibio se desgarra.",
  "Wrap the whole slab and leave it a week before cutting; this is not optional, it is the recipe.":
    "Envuelva la placa entera y déjela una semana antes de cortar; esto no es opcional, es la receta.",
  "Make it a week to ten days ahead. It is inedible on day one and excellent on day seven.":
    "Hágalo con una semana o diez días de anticipación. El primer día es incomible y el séptimo es excelente.",
  "Weeks in a tin. An October product that can be made in September.":
    "Semanas en un tarro. Un producto de octubre que se puede hacer en setiembre.",
  "One of the few things here you can make a month of stock of, so make it when the oven is free.":
    "Una de las pocas cosas de esta carta de las que se puede tener un mes de stock, así que hágalo cuando el horno esté libre.",

  // ---- 163 Aguaymanto Crumble Cake (vegan) ----
  "40 squares": "40 cuadrados",
  "Whisk oil, water, caster sugar and vanilla, then fold in the flour and raising agent quickly.":
    "Bata el aceite, el agua, el azúcar fina y la vainilla, e integre rápido la harina y el leudante.",
  "Spread it thin in lined trays and scatter the aguaymanto over rather than folding it in.":
    "Extienda delgado en bandejas forradas y esparza el aguaymanto por encima en vez de integrarlo.",
  "Rub the oats and brown sugar together with a little more oil into a loose crumble.":
    "Arene la avena y el azúcar rubia con un poco más de aceite hasta un crumble suelto.",
  "Scatter the crumble over the fruit thickly and unpressed, right out to the edges.":
    "Esparza el crumble sobre la fruta en capa gruesa y sin presionar, hasta los bordes.",
  "Bake at 180 °C for 40 to 45 minutes until the crumble is set and the fruit bubbles at the corners.":
    "Hornee a 180 °C por 40 a 45 minutos hasta que el crumble cuaje y la fruta burbujee en las esquinas.",
  "Cool completely before cutting; the fruit layer needs to firm up or the squares fall apart.":
    "Enfríe por completo antes de cortar; la capa de fruta necesita tomar firmeza o los cuadrados se deshacen.",
  "Bake 2 days ahead. No dairy and no egg, so it keeps better than a butter tray bake.":
    "Hornee 2 días antes. Sin lácteos ni huevo, así que se conserva mejor que un tray bake con mantequilla.",
  "Two days at room temperature. Vegan, and nobody has to be told it is.":
    "Dos días a temperatura ambiente. Vegano, y no hace falta que nadie se entere.",

  // ---- 164 Lemon & Muna Drizzle Cake ----
  "Zest all twelve lemons before juicing any of them — it cannot be done the other way round.":
    "Ralle los doce limones antes de exprimir ninguno — no se puede hacer al revés.",
  "Cream the butter and caster sugar, add eggs one at a time, then fold in flour and lemon zest.":
    "Cremee la mantequilla y el azúcar fina, agregue los huevos de a uno e integre la harina y la ralladura de limón.",
  "Bake at 175 °C for 40 to 45 minutes until a skewer comes out clean.":
    "Hornee a 175 °C por 40 a 45 minutos hasta que una brocheta salga limpia.",
  "Steep the muna in the hot lemon juice for 10 minutes, then strain it and stir in the granulated sugar.":
    "Infusione la muña en el jugo de limón caliente por 10 minutos, cuele e incorpore el azúcar granulada.",
  "Skewer the hot loaves all over and spoon the syrup on in three passes, letting each soak in.":
    "Pinche los kekes calientes por todos lados y reparta el almíbar en tres pasadas, dejando que cada una penetre.",
  "Leave them in the tins until cold, or the syrup runs out of the bottom instead of into the crumb.":
    "Déjelos en los moldes hasta que enfríen, o el almíbar se escurre por abajo en vez de entrar en la miga.",
  "Bake and drizzle 2 days ahead. The muna comes forward on the second day.":
    "Hornee y almibare 2 días antes. La muña se hace notar al segundo día.",
  "Three days wrapped. Travels well and does not need refrigeration.":
    "Tres días envuelto. Viaja bien y no necesita refrigeración.",

  // ---- 165 Papa Amarilla Chocolate Cake ----
  "Boil the potatoes whole, peel them hot and rice them, then let them cool completely and dry out.":
    "Hierva las papas enteras, pélelas en caliente y páselas por prensapuré, y déjelas enfriar por completo y secarse.",
  "Melt the chocolate with the butter and cool it to blood heat before anything else goes in.":
    "Derrita el chocolate con la mantequilla y enfríelo a temperatura corporal antes de agregar nada más.",
  "Beat the yolks with two-thirds of the sugar, then fold in the riced potato and the ground almonds.":
    "Bata las yemas con dos tercios del azúcar e integre la papa prensada y la almendra molida.",
  "Combine with the chocolate — the potato is what makes this fudgy rather than heavy.":
    "Combine con el chocolate — la papa es lo que la vuelve cremosa en vez de pesada.",
  "Whip the whites with the remaining sugar and fold them in; there is no flour to lift it.":
    "Bata las claras con el azúcar restante e intégrelas; no hay harina que la levante.",
  "Bake at 170 °C for 40 to 45 minutes and cool fully in the tin before turning out.":
    "Hornee a 170 °C por 40 a 45 minutos y enfríe por completo en el molde antes de desmoldar.",
  "Bake the day before. It firms overnight and cuts far more cleanly cold.":
    "Hornee el día anterior. Toma firmeza durante la noche y se corta mucho más limpio en frío.",
  "All day at room temperature. Wheat-free, and the same trick as the Scottish macaroon.":
    "Todo el día a temperatura ambiente. Sin trigo, y con el mismo truco que el macaroon escocés.",

  // ---- 166 Tarta de Chirimoya y Crema ----
  "Line the rings with cacao pastry, chill, and blind bake at 175 °C until dry and sandy.":
    "Forre los aros con masa de cacao, refrigere y hornee en blanco a 175 °C hasta que esté seca y arenosa.",
  "Scoop the chirimoya and pick out every seed — they are bitter and there is no forgiving one.":
    "Saque la pulpa de la chirimoya y retire todas las pepas — son amargas y no se perdona ni una.",
  "Crush half the flesh with lime and sugar, and keep the other half in rough pieces.":
    "Aplaste la mitad de la pulpa con limón y azúcar, y deje la otra mitad en trozos rústicos.",
  "Warm a third of the cream, dissolve the softened gelatine into it and cool to room temperature.":
    "Caliente un tercio de la crema, disuelva en ella la gelatina hidratada y enfríe a temperatura ambiente.",
  "Fold the gelatine cream through the rest, whipped to soft peak, with the crushed chirimoya.":
    "Integre la crema con gelatina al resto, batido a picos suaves, junto con la chirimoya aplastada.",
  "Fill the cases, set 4 hours, and finish with the reserved fruit and cacao nibs at the venue.":
    "Rellene las bases, deje cuajar 4 horas y termine con la fruta reservada y los nibs de cacao en el local.",
  "Bake the cases 3 days ahead. Fill the day before; chirimoya browns, so top at the venue.":
    "Hornee las bases 3 días antes. Rellene el día anterior; la chirimoya se oxida, así que corone en el local.",
  "Needs refrigeration. Ninety minutes out before the set softens.":
    "Necesita refrigeración. Noventa minutos fuera antes de que el cuajado se ablande.",

  // ---- 167 Coconut & Lucuma Traybake (vegan) ----
  "Warm the coconut oil only until it runs — hot oil cooks the flour into lumps on contact.":
    "Caliente el aceite de coco solo hasta que se vuelva líquido — el aceite caliente cuaja la harina en grumos al contacto.",
  "Whisk the oil, coconut milk and half the lucuma pulp together until completely smooth.":
    "Bata el aceite, la leche de coco y la mitad de la pulpa de lúcuma hasta que quede completamente liso.",
  "Fold in the flour, sugar, baking powder and two-thirds of the desiccated coconut.":
    "Integre la harina, el azúcar, el polvo de hornear y dos tercios del coco rallado.",
  "Spread in lined trays and bake at 180 °C for 30 to 35 minutes until the edges pull away.":
    "Extienda en bandejas forradas y hornee a 180 °C por 30 a 35 minutos hasta que los bordes se despeguen.",
  "Beat the remaining lucuma with a little coconut milk into a thin icing.":
    "Bata la lúcuma restante con un poco de leche de coco hasta un glaseado ligero.",
  "Ice the cold traybake, scatter the last of the coconut over and cut once the icing has set.":
    "Glasee el tray bake frío, esparza el coco restante y corte cuando el glaseado haya cuajado.",
  "Bake 3 days ahead. Coconut oil keeps it moist longer than butter would.":
    "Hornee 3 días antes. El aceite de coco lo mantiene húmedo más tiempo que la mantequilla.",
  "Three days at room temperature. Vegan, dairy-free, and it survives a hot van better than anything else here.":
    "Tres días a temperatura ambiente. Vegano, sin lácteos, y sobrevive una camioneta caliente mejor que cualquier otra cosa de esta carta.",

  // ---- 168 Whisky Truffle Torte ----
  "3 tortes, 36 slices": "3 tortas, 36 porciones",
  "There is no flour in this at all, so keep it off every wheat surface if a coeliac is eating.":
    "Esta no lleva nada de harina, así que manténgala lejos de toda superficie con trigo si come un celíaco.",
  "Melt the chocolate and butter together over water and cool it to just above blood heat.":
    "Derrita el chocolate y la mantequilla juntos a baño maría y enfríelos hasta apenas por encima de la temperatura corporal.",
  "Whisk the eggs and sugar over a bain-marie until they triple and hold a ribbon for three seconds.":
    "Bata los huevos y el azúcar a baño maría hasta que tripliquen y sostengan la cinta por tres segundos.",
  "Fold the chocolate through in three additions, keeping as much air as you can.":
    "Integre el chocolate en tres adiciones, conservando todo el aire que pueda.",
  "Stir the whisky in at the very end, off the heat, so the spirit reads on the palate.":
    "Incorpore el whisky al final, fuera del fuego, para que el destilado se lea en el paladar.",
  "Bake in a water bath at 160 °C for 32 to 35 minutes — it should still wobble as one piece.":
    "Hornee a baño maría a 160 °C por 32 a 35 minutos — debe seguir temblando como una sola pieza.",
  "Bake 2 days ahead. It slices cleanly cold and comes to room temperature in an hour.":
    "Hornee 2 días antes. Se corta limpio en frío y llega a temperatura ambiente en una hora.",
  "Four hours at room temperature. The richest thing on the sheet, so cut it small.":
    "Cuatro horas a temperatura ambiente. Lo más contundente de toda la hoja, así que corte porciones chicas.",

  // ---- 169 Pisco Sour Meringue Tart ----
  "3 tarts, 30 slices": "3 tartas, 30 porciones",
  "Blind bake the pastry cases until fully dry — a lime curd will soften an underbaked base by service.":
    "Hornee las bases en blanco hasta que estén completamente secas — una crema de limón ablanda una base poco horneada para la hora del servicio.",
  "Cook the lime juice, yolks and half the sugar over water until it coats the back of a spoon.":
    "Cocine el jugo de limón, las yemas y la mitad del azúcar a baño maría hasta que nape el dorso de la cuchara.",
  "Beat the butter in off the heat, a cube at a time, then stir the pisco through and pass it.":
    "Incorpore la mantequilla fuera del fuego, de a un cubo, luego integre el pisco y cuele.",
  "Fill the cases and chill until the curd is fully set, at least three hours.":
    "Rellene las bases y refrigere hasta que la crema cuaje del todo, al menos tres horas.",
  "Boil the remaining sugar with water to 118 °C and pour it onto whipping whites for Italian meringue.":
    "Hierva el azúcar restante con agua hasta 118 °C y viértalo sobre las claras batiéndose para el merengue italiano.",
  "Pipe the meringue on and torch it at the venue — torched early, it weeps within the hour.":
    "Ponga el merengue con manga y quémelo con soplete en el local — quemado antes de tiempo, llora en una hora.",
  "Cases 3 days, curd 2 days. Meringue on the day and torched at the venue, never before.":
    "Bases 3 días, crema 2 días. El merengue el mismo día y quemado en el local, nunca antes.",
  "Two hours torched. The alcohol means it needs the licence, same as the cocktail.":
    "Dos horas una vez quemada. El alcohol implica que necesita la licencia, igual que el cóctel.",

  // ---- 170 Kiwicha Honey Cake ----
  "Toast the kiwicha until it pops and cool it — it is the texture the whole cake is built on.":
    "Tueste la kiwicha hasta que reviente y enfríela — es la textura sobre la que se construye toda la torta.",
  "Cream the butter and sugar, beat in the eggs, then fold in the flour and two-thirds of the kiwicha.":
    "Cremee la mantequilla y el azúcar, incorpore los huevos batiendo e integre la harina y dos tercios de la kiwicha.",
  "Bake in four thin layers at 180 °C for 18 to 20 minutes each; thin layers are the point.":
    "Hornee en cuatro capas delgadas a 180 °C por 18 a 20 minutos cada una; las capas delgadas son el punto.",
  "Warm the algarrobina slightly and brush each cooled layer with it so it soaks in.":
    "Caliente ligeramente la algarrobina y pincele cada capa fría con ella para que penetre.",
  "Whip the cream to soft peak with a little algarrobina folded through it.":
    "Bata la crema a picos suaves con un poco de algarrobina integrada.",
  "Stack four layers with cream between, and press the remaining kiwicha round the sides.":
    "Apile las cuatro capas con crema entre ellas y presione la kiwicha restante alrededor de los costados.",
  "Bake the layers 2 days ahead. Assemble the day before so the algarrobina soaks through.":
    "Hornee las capas 2 días antes. Arme el día anterior para que la algarrobina penetre.",
  "Needs refrigeration once assembled. Two hours out at an event.":
    "Necesita refrigeración una vez armada. Dos horas fuera en un evento.",

  // ---- 171 Clootie Dumpling, Chancaca ----
  "Scald the cloth in boiling water, wring it out and flour it heavily — this is what makes the skin.":
    "Escalde el paño en agua hirviendo, escúrralo y enharínelo abundantemente — eso es lo que forma la piel.",
  "Mix the dry ingredients, rub in the suet, then bring it together with the melted chancaca and milk.":
    "Mezcle los ingredientes secos, arene el sebo y una la masa con la chancaca derretida y la leche.",
  "Turn the mixture onto the floured cloth, gather it and tie it loosely to leave room to swell.":
    "Vuelque la mezcla sobre el paño enharinado, júntelo y átelo flojo para dejar espacio a que crezca.",
  "Simmer for three and a half hours on an upturned plate, topping the water up so it never stops.":
    "Cocine a fuego lento tres horas y media sobre un plato invertido, reponiendo agua para que nunca pare.",
  "Turn it out and dry the skin in a low oven for 15 minutes, which is the step everyone skips.":
    "Desmolde y seque la piel en horno bajo por 15 minutos, que es el paso que todo el mundo se salta.",
  "Cool completely before slicing; it is better on day three than on the day it is made.":
    "Enfríe por completo antes de cortar; está mejor al tercer día que el día en que se hace.",
  "Steam a fortnight ahead. It keeps like a Christmas pudding and improves the whole time.":
    "Cocínelo al vapor con quince días de anticipación. Se conserva como un pudín de Navidad y mejora todo ese tiempo.",
  "Weeks wrapped. Slices cold, fries in butter for breakfast the next morning.":
    "Semanas envuelto. Se corta frío y se fríe en mantequilla para el desayuno del día siguiente.",
  "One pot takes one dumpling. Four dumplings means four pots and a full hob for an afternoon.":
    "Una olla acepta un dumpling. Cuatro dumplings significan cuatro ollas y toda la cocina ocupada una tarde.",

  // ---- 172 Papa Rellena, Haggis ----
  "Boil the papa amarilla whole, peel hot and rice it, then spread it out to dry off the steam.":
    "Hierva la papa amarilla entera, pélela en caliente, páselas por prensapuré y extiéndala para que suelte el vapor.",
  "Season the potato hard and knead it briefly — it has to hold a shell without a binder.":
    "Sazone la papa con fuerza y amásela brevemente — tiene que sostener una cáscara sin ningún ligante.",
  "Cook the haggis mix with the onion and aji panca until it is dry enough to hold a shape.":
    "Cocine la mezcla de haggis con la cebolla y el ají panca hasta que esté lo bastante seca para tomar forma.",
  "Cool both completely. Warm potato around warm filling collapses in the fryer every time.":
    "Enfríe ambos por completo. Papa tibia alrededor de relleno tibio se desarma en la freidora siempre.",
  "Take 100 g of potato, flatten it in a wet palm, load 30 g of filling and close it into a lemon shape.":
    "Tome 100 g de papa, aplástela en la palma mojada, cargue 30 g de relleno y ciérrela en forma de limón.",
  "Flour, egg, and fry at 175 °C for 4 minutes until the shell is dark gold and set hard.":
    "Harina, huevo y fría a 175 °C por 4 minutos hasta que la cáscara esté dorada oscura y bien firme.",
  "Shape and chill the day before, or freeze them. Fry from chilled, never from warm.":
    "Forme y refrigere el día anterior, o congélelas. Fría desde frío, nunca desde tibio.",
  "Fry to order. Fifteen minutes on a rack and the shell softens from the inside.":
    "Fría al momento. Quince minutos sobre una rejilla y la cáscara se ablanda desde adentro.",
  "Shaping is the cost: about 40 seconds each. Budget an hour of labour per 90 pieces.":
    "El costo está en formarlas: unos 40 segundos cada una. Calcule una hora de trabajo por cada 90 piezas.",

  // ---- 173 Tequenos de Paria y Whisky ----
  "80 tequenos": "80 tequeños",
  "Cut the paria into batons about 8 cm by 1.5 cm — thicker and the pastry burns before the cheese melts.":
    "Corte el paria en bastones de unos 8 cm por 1,5 cm — más gruesos y la masa se quema antes de que el queso funda.",
  "Lay a wrapper on the diagonal, set the baton across the near corner and roll it once.":
    "Coloque una lámina en diagonal, ponga el bastón sobre la esquina más cercana y enrolle una vez.",
  "Fold both sides in tight and keep rolling, sealing the last corner with egg. Air trapped inside bursts the roll.":
    "Doble ambos lados bien apretados y siga enrollando, sellando la última esquina con huevo. El aire atrapado adentro revienta el rollo.",
  "Chill the rolled tequenos 30 minutes so the pastry firms and holds its seal.":
    "Refrigere los tequeños armados 30 minutos para que la masa firme y mantenga el sellado.",
  "Melt the chancaca with a splash of water, add the cream, then stir the whisky in off the heat.":
    "Derrita la chancaca con un chorro de agua, agregue la crema e incorpore el whisky fuera del fuego.",
  "Fry at 180 °C for 2 to 3 minutes until blistered and gold, and serve the dip warm alongside.":
    "Fría a 180 °C por 2 a 3 minutos hasta que ampollen y doren, y sirva la salsa tibia al lado.",
  "Roll and freeze. Fry from frozen at 170 °C for 4 minutes. The dip keeps a week.":
    "Arme y congele. Fría desde congelado a 170 °C por 4 minutos. La salsa dura una semana.",
  "Ten minutes. The cheese sets back to rubber as it cools, so fire them in rounds.":
    "Diez minutos. El queso vuelve a ser goma al enfriar, así que prepárelos por tandas.",

  // ---- 174 Choclo con Queso, Mostaza ----
  "Boil the choclo in unsalted water with a little sugar and an anise seed, 20 minutes.":
    "Hierva el choclo en agua sin sal con un poco de azúcar y una semilla de anís, 20 minutos.",
  "Salting the water toughens the kernels, which is why the sugar goes in and the salt does not.":
    "Salar el agua endurece los granos, por eso entra el azúcar y no la sal.",
  "Beat the butter with the mustard, chopped chives and a pinch of salt into a rough compound.":
    "Bata la mantequilla con la mostaza, el cebollín picado y una pizca de sal hasta una mantequilla compuesta rústica.",
  "Cut each cob into three and thread a slab of queso fresco onto the side of each piece.":
    "Corte cada choclo en tres y ensarte una lonja de queso fresco al costado de cada trozo.",
  "Melt a spoon of the mustard butter over the hot corn so it runs into the kernels.":
    "Derrita una cucharada de la mantequilla de mostaza sobre el choclo caliente para que corra entre los granos.",
  "Finish with flaked salt and serve immediately; cold choclo is a different and worse thing.":
    "Termine con sal en escamas y sirva de inmediato; el choclo frío es otra cosa, y peor.",
  "The butter keeps two weeks. Boil the choclo on the day — it goes starchy overnight.":
    "La mantequilla dura dos semanas. Hierva el choclo el mismo día — de un día para otro se pone harinoso.",
  "Forty minutes in a covered tray. This is a dish that wants to be eaten hot.":
    "Cuarenta minutos en bandeja tapada. Es un plato que quiere comerse caliente.",

  // ---- 175 Solterito de Quinua y Berros ----
  "Rinse the quinoa in three changes of water or it will be bitter, then cook it 14 minutes and cool it flat.":
    "Lave la quinua en tres cambios de agua o amargará, cocínela 14 minutos y enfríela extendida.",
  "Deseed the rocoto and dice it fine — the seeds carry heat that overwhelms a salad.":
    "Despepite el rocoto y píquelo fino — las pepas llevan un picor que arrasa con una ensalada.",
  "Pick the watercress into short sprigs and keep it dry and cold until the last moment.":
    "Separe los berros en ramitas cortas y manténgalos secos y fríos hasta el último momento.",
  "Dress the quinoa, tomato, onion, olives and rocoto with oil, lime and salt.":
    "Adere la quinua, el tomate, la cebolla, las aceitunas y el rocoto con aceite, limón y sal.",
  "Fold the watercress through as it goes out, never before; it wilts within ten minutes of dressing.":
    "Integre los berros justo al salir, nunca antes; se marchitan a los diez minutos de aderezados.",
  "Cook the quinoa and cut the vegetables the day before. Dress and add the cress at the venue.":
    "Cocine la quinua y corte las verduras el día anterior. Adere y agregue los berros en el local.",
  "One hour dressed. Vegan as built, and one of the few that is.":
    "Una hora una vez aderezado. Vegano tal como está armado, y de los pocos que lo son.",

  // ---- 176 Cau Cau de Setas ----
  "Tear the mushrooms rather than slicing them; a torn edge holds sauce the way tripe does.":
    "Rompa los champiñones con la mano en vez de cortarlos; un borde rasgado retiene la salsa como lo hace el mondongo.",
  "Dry-fry them hard in batches until they squeak and colour, then set them aside.":
    "Séllelos en seco con fuerza por tandas hasta que chirríen y tomen color, y resérvelos.",
  "Build the aderezo: onion, garlic and aji amarillo cooked slowly in oil until it is almost jammy.":
    "Arme el aderezo: cebolla, ajo y ají amarillo cocinados despacio en aceite hasta que queden casi como mermelada.",
  "Add the diced potato and just enough water to cover, and simmer until the potato is nearly done.":
    "Agregue la papa en cubos y el agua justa para cubrir, y cocine a fuego lento hasta que la papa esté casi lista.",
  "Stir the oats in for the last 8 minutes; they thicken it where a cau cau usually leans on the potato alone.":
    "Incorpore la avena en los últimos 8 minutos; espesa donde un cau cau normalmente se apoya solo en la papa.",
  "Return the mushrooms, fold the hierbabuena through off the heat, and check the salt twice.":
    "Devuelva los champiñones, integre la hierbabuena fuera del fuego y revise la sal dos veces.",
  "Better the next day. Make it whole and reheat gently, adding a little water.":
    "Mejor al día siguiente. Hágalo completo y recaliéntelo suavemente, agregando un poco de agua.",
  "Three hours in a chafing dish. Vegan, and it does not read as a compromise.":
    "Tres horas en chafing dish. Vegano, y no se lee como una concesión.",

  // ---- 177 Seco de Cordero, Stout ----
  "Brown the lamb hard in batches. A seco built on pale meat is a stew, not a seco.":
    "Dore el cordero con fuerza por tandas. Un seco armado sobre carne pálida es un guiso, no un seco.",
  "Blitz the culantro with a little water to a bright green liquor and keep it back until the end.":
    "Licúe el culantro con un poco de agua hasta un líquido verde intenso y guárdelo hasta el final.",
  "Cook the onion, garlic and aji amarillo down to a dark aderezo in the lamb fat.":
    "Cocine la cebolla, el ajo y el ají amarillo hasta un aderezo oscuro en la grasa del cordero.",
  "Return the lamb, pour in the stout, and braise covered for 90 minutes until it gives to a spoon.":
    "Devuelva el cordero, vierta la cerveza negra y brasee tapado por 90 minutos hasta que ceda a la cuchara.",
  "Add the potato for the last 20 minutes so it takes on the sauce without collapsing.":
    "Agregue la papa en los últimos 20 minutos para que tome la salsa sin deshacerse.",
  "Fork the culantro liquor through off the heat — cooked in, it turns brown and tastes of nothing.":
    "Integre el líquido de culantro con un tenedor fuera del fuego — cocinado dentro se pone marrón y no sabe a nada.",
  "Braise the day before and hold back the culantro. It reheats better than almost anything.":
    "Brasee el día anterior y reserve el culantro. Se recalienta mejor que casi cualquier cosa.",
  "Three hours in a chafing dish, but add the culantro only when it goes out.":
    "Tres horas en chafing dish, pero agregue el culantro solo al momento de sacarlo.",

  // ---- 178 Adobo Arequipeno, Ale ----
  "Marinate the pork overnight in the aji panca, vinegar, oregano, garlic and plenty of salt.":
    "Macere el cerdo toda la noche en el ají panca, el vinagre, el orégano, el ajo y bastante sal.",
  "The overnight is the dish. Adobo made same-day tastes of raw paste and nothing else.":
    "La noche entera es el plato. Un adobo hecho el mismo día sabe a pasta cruda y a nada más.",
  "Bring the pork and its marinade to a bare simmer in a heavy pot with the ale poured over.":
    "Lleve el cerdo y su adobo a un hervor apenas perceptible en una olla pesada con la cerveza vertida encima.",
  "Cook covered and barely moving for two hours; a hard boil makes the pork stringy.":
    "Cocine tapado y apenas moviéndose por dos horas; un hervor fuerte deja el cerdo fibroso.",
  "Add the onion wedges and rocoto for the last 25 minutes so they soften without dissolving.":
    "Agregue los gajos de cebolla y el rocoto en los últimos 25 minutos para que se ablanden sin deshacerse.",
  "Rest it off the heat for 20 minutes before service — the sauce thickens as it settles.":
    "Repose fuera del fuego 20 minutos antes del servicio — la salsa espesa al asentarse.",
  "Marinate two days ahead, cook the day before. It is a better dish reheated.":
    "Macere dos días antes y cocine el día anterior. Es mejor plato recalentado.",
  "Three hours held gently. Traditionally a Sunday-morning dish; sell it as a Sunday lunch.":
    "Tres horas mantenido con suavidad. Tradicionalmente es un plato de domingo por la mañana; véndalo como almuerzo dominical.",

  // ---- 179 Tacu Tacu con Morcilla ----
  "Use rice cooked the day before. Fresh rice is too wet and the cake will never crisp.":
    "Use arroz cocido el día anterior. El arroz fresco tiene demasiada humedad y la torta nunca queda crocante.",
  "Mash a third of the beans and leave the rest whole so the cake has both body and texture.":
    "Aplaste un tercio de los frijoles y deje el resto enteros para que la torta tenga cuerpo y textura.",
  "Build the aderezo with onion and aji amarillo, then fold rice and beans through it off the heat.":
    "Arme el aderezo con cebolla y ají amarillo, e integre el arroz y los frijoles fuera del fuego.",
  "Crumble the morcilla and fry it separately until the fat runs and the edges catch.":
    "Desmenuce la morcilla y fríala aparte hasta que suelte la grasa y los bordes se doren.",
  "Fold the morcilla through, then form the mixture into an oval in a hot, well-oiled pan.":
    "Integre la morcilla y forme la mezcla en un óvalo dentro de una sartén caliente y bien aceitada.",
  "Press it flat and leave it alone for four minutes a side; the crust is the entire point.":
    "Aplástelo y déjelo quieto cuatro minutos por lado; la costra es todo el punto.",
  "Cook the rice and beans a day ahead. The cake itself is formed and crisped to order.":
    "Cocine el arroz y los frijoles un día antes. La torta se forma y se dora al momento.",
  "Serve within ten minutes of the pan. Held, the crust softens and it becomes rice and beans.":
    "Sirva dentro de diez minutos de salir de la sartén. En espera, la costra se ablanda y vuelve a ser arroz con frijoles.",
  "One pan makes four portions. Above 40 guests you need a plancha, not a bigger pan.":
    "Una sartén hace cuatro porciones. Por encima de 40 invitados necesita una plancha, no una sartén más grande.",

  // ---- 180 Sopa Criolla con Avena ----
  "Toast the oats dry until they smell of biscuit; untoasted they turn the soup to porridge.":
    "Tueste la avena en seco hasta que huela a galleta; sin tostar convierte la sopa en porridge.",
  "Sear the sliced beef fast and hard in a wide pan, then lift it out while it is still rare.":
    "Selle la carne cortada rápido y fuerte en una sartén amplia, y retírela mientras siga roja.",
  "Build the aderezo with onion, garlic and aji panca in the same pan until it darkens.":
    "Arme el aderezo con cebolla, ajo y ají panca en la misma sartén hasta que oscurezca.",
  "Add the stock and the oats and simmer 15 minutes, until the oats are soft but still separate.":
    "Agregue el caldo y la avena y cocine a fuego lento 15 minutos, hasta que la avena esté suave pero suelta.",
  "Pour in the evaporated milk and hold it below a simmer — boiled, it will split.":
    "Vierta la leche evaporada y manténgala por debajo del hervor — hervida, se corta.",
  "Return the beef, then poach the eggs directly in the soup for the last 4 minutes.":
    "Devuelva la carne y escalfe los huevos directamente en la sopa durante los últimos 4 minutos.",
  "Make the base a day ahead. Beef and eggs go in during the last five minutes, on site.":
    "Haga la base un día antes. La carne y los huevos entran en los últimos cinco minutos, en el local.",
  "Ninety minutes below a simmer. The oats keep swelling, so hold back a litre of stock to loosen it.":
    "Noventa minutos por debajo del hervor. La avena sigue hinchando, así que reserve un litro de caldo para aligerar.",

  // ---- 181 Chupe de Zapallo Loche ----
  "Roast the squash rather than boiling it — boiled zapallo gives you a watery chupe.":
    "Hornee el zapallo en vez de hervirlo — el zapallo hervido da un chupe aguado.",
  "Toast the oatmeal in a dry pan until it colours, which is what makes this taste rich without dairy.":
    "Tueste la avena en sartén seca hasta que tome color, que es lo que le da untuosidad sin lácteos.",
  "Build the aderezo with onion, garlic and aji amarillo cooked slowly in oil.":
    "Arme el aderezo con cebolla, ajo y ají amarillo cocinados despacio en aceite.",
  "Add the squash, the potato and water to cover, and simmer until everything is soft.":
    "Agregue el zapallo, la papa y agua hasta cubrir, y cocine a fuego lento hasta que todo esté blando.",
  "Blend half and leave half in pieces; a fully smooth chupe reads as soup, not as a bowl.":
    "Licúe la mitad y deje la otra mitad en trozos; un chupe completamente liso se lee como sopa, no como bowl.",
  "Stir the toasted oatmeal in for the last five minutes and finish with torn huacatay.":
    "Incorpore la avena tostada en los últimos cinco minutos y termine con huacatay rasgado a mano.",
  "Make it two days ahead. It thickens overnight, so keep stock back to loosen it.":
    "Hágalo dos días antes. Espesa durante la noche, así que reserve caldo para aligerarlo.",
  "Three hours in a chafing dish. Vegan, and it still eats rich.":
    "Tres horas en chafing dish. Vegano, y aun así se come untuoso.",

  // ---- 182 Ensalada de Palta y Berros ----
  "Buy the avocados three days out and let them ripen on the bench; a hard palta cannot be rescued.":
    "Compre las paltas con tres días de anticipación y déjelas madurar sobre la mesa; una palta dura no se rescata.",
  "Whisk the mustard, lime juice and oil into a dressing that is sharper than feels right on the spoon.":
    "Bata la mostaza, el jugo de limón y el aceite hasta un aderezo más ácido de lo que parece correcto en la cuchara.",
  "Slice the onion paper-thin and soak it in lime juice for ten minutes to soften its edge.":
    "Corte la cebolla finísima y remójela en jugo de limón por diez minutos para quitarle el filo.",
  "Pick the watercress into sprigs and keep it dry — wet cress will not hold a dressing.":
    "Separe los berros en ramitas y manténgalos secos — un berro mojado no retiene el aderezo.",
  "Cut the avocado only as the trays go out; it browns within twenty minutes however much lime is on it.":
    "Corte la palta solo cuando salen las bandejas; se oxida en veinte minutos por más limón que lleve.",
  "Dress the cress separately, then build in layers so the avocado is not crushed by mixing.":
    "Adere los berros aparte y arme por capas para que la palta no se aplaste al mezclar.",
  "Dressing keeps three days. Everything else is a same-day job and the avocado is a last-minute one.":
    "El aderezo dura tres días. Todo lo demás es trabajo del mismo día y la palta es de último minuto.",
  "Twenty minutes cut. Vegan, and the cheapest green on the sheet.":
    "Veinte minutos una vez cortada. Vegana, y la verdura más barata de toda la hoja.",

  // ---- 183 Huancaina Escocesa ----
  "Fry the aji amarillo paste in oil for five minutes until it darkens and loses its raw edge.":
    "Fría la pasta de ají amarillo en aceite por cinco minutos hasta que oscurezca y pierda el filo crudo.",
  "Let the paste cool before blending or the heat will split the cheese sauce.":
    "Deje enfriar la pasta antes de licuar o el calor cortará la salsa de queso.",
  "Blend both cheeses with the crackers, the evaporated milk and the cooled aji until it pours slowly.":
    "Licúe ambos quesos con las galletas de soda, la leche evaporada y el ají frío hasta que caiga despacio.",
  "The cheddar is what makes this set firmer than a classic huancaina, which is why it suits a buffet.":
    "El cheddar es lo que hace que cuaje más firme que una huancaína clásica, y por eso funciona en un buffet.",
  "Nap the potatoes rather than drowning them, and finish with olives and a hard-boiled egg.":
    "Nape las papas en vez de ahogarlas, y termine con aceitunas y huevo duro.",
  "The sauce keeps two days and thickens, so slacken it with milk before serving.":
    "La salsa dura dos días y espesa, así que aflójela con leche antes de servir.",
  "Three hours at room temperature. Cover it — the surface skins within twenty minutes.":
    "Tres horas a temperatura ambiente. Tápela — la superficie forma película en veinte minutos.",

  // ---- 184 Yuca Frita, Huancaina de Muna ----
  "Peel the yuca and pull out the woody cord down the centre; it never softens and nobody wants it.":
    "Pele la yuca y saque la fibra leñosa del centro; nunca se ablanda y nadie la quiere.",
  "Boil it in salted water until a knife goes in easily but before it starts to fall apart.":
    "Hiérvala en agua con sal hasta que el cuchillo entre fácil pero antes de que empiece a deshacerse.",
  "Drain and steam-dry it, then cool completely — wet yuca in hot oil is dangerous as well as soggy.":
    "Escurra y seque al vapor, luego enfríe por completo — yuca húmeda en aceite caliente es peligrosa además de aguada.",
  "Steep the muna in the warm evaporated milk for ten minutes, then strain it out.":
    "Infusione la muña en la leche evaporada tibia por diez minutos y cuélela.",
  "Blend the muna milk with the aji amarillo, queso fresco and crackers into a pourable sauce.":
    "Licúe la leche de muña con el ají amarillo, el queso fresco y las galletas de soda hasta una salsa que se pueda verter.",
  "Fry the yuca at 180 °C until blistered and gold, salt it immediately, and serve the sauce alongside.":
    "Fría la yuca a 180 °C hasta que ampolle y dore, sale de inmediato y sirva la salsa al lado.",
  "Boil and cool the yuca the day before. The sauce keeps two days.":
    "Hierva y enfríe la yuca el día anterior. La salsa dura dos días.",
  "Fry to order. Yuca goes leathery within fifteen minutes of leaving the oil.":
    "Fría al momento. La yuca se vuelve correosa a los quince minutos de salir del aceite.",

  // ---- 185 Anticucho de Champinon ----
  "60 skewers": "60 brochetas",
  "Choose mushrooms the size of a walnut and leave them whole; sliced, they steam instead of charring.":
    "Elija champiñones del tamaño de una nuez y déjelos enteros; cortados, se cocinan al vapor en vez de tostarse.",
  "Marinate at least four hours. Mushrooms take up marinade faster than meat but need the time to season through.":
    "Macere al menos cuatro horas. Los champiñones absorben el adobo más rápido que la carne pero necesitan tiempo para sazonarse por dentro.",
  "Thread three to a skewer, leaving a little space between so the heat gets round each one.":
    "Ensarte tres por brocheta, dejando algo de espacio entre ellos para que el calor rodee a cada uno.",
  "Grill on a very hot plancha, three minutes a side, basting with the leftover marinade as you turn.":
    "Ase en plancha muy caliente, tres minutos por lado, bañando con el adobo sobrante al voltear.",
  "They are done when the edges char and the centres give — undercooked, they are squeaky.":
    "Están listos cuando los bordes se tuestan y el centro cede — poco cocidos, chirrían al morder.",
  "Marinate and skewer the day before. Grilling is a venue job.":
    "Macere y ensarte el día anterior. El asado es trabajo del local.",
  "Grill to order. Vegan, and on a mixed table it outsells the beef heart.":
    "Ase al momento. Vegano, y en una mesa mixta vende más que el corazón de res.",
  "About 80 skewers an hour off a 1 m plancha, the same as the lamb.":
    "Unas 80 brochetas por hora en una plancha de 1 m, lo mismo que el cordero.",

  // ---- 186 Empanada de Lomo Saltado ----
  "Make a shortcrust rather than an empanada dough — this is the bridie idea applied to a saltado.":
    "Haga una masa quebrada en lugar de masa de empanada — esta es la idea del bridie aplicada a un saltado.",
  "Rest the pastry an hour in the fridge and roll it to 3 mm.":
    "Deje reposar la masa una hora en la refrigeradora y estírela a 3 mm.",
  "Sear the beef in a ferociously hot pan in small batches and pull it while it is still rare.":
    "Selle la carne en una sartén ferozmente caliente en tandas chicas y sáquela mientras siga roja.",
  "Fry the onion 30 seconds, add tomato, deglaze with sillao and vinegar, and take it off immediately.":
    "Fría la cebolla 30 segundos, agregue tomate, desglase con sillao y vinagre, y retire de inmediato.",
  "Drain the filling in a colander and cool it fully; a saltado carries far too much liquid for pastry.":
    "Escurra el relleno en un colador y enfríelo del todo; un saltado carga demasiado líquido para una masa.",
  "Fill, crimp, chill 20 minutes, egg-wash and bake at 200 °C for 22 minutes.":
    "Rellene, repulgue, refrigere 20 minutos, pincele con huevo y hornee a 200 °C por 22 minutos.",
  "Freeze filled and crimped. Bake from frozen at 190 °C for 28 minutes.":
    "Congele rellenas y repulgadas. Hornee desde congelado a 190 °C por 28 minutos.",
  "Two hours warm, four at room temperature. The drained filling is what makes that possible.":
    "Dos horas tibias, cuatro a temperatura ambiente. El relleno escurrido es lo que lo hace posible.",

  // ---- 187 Pan Chuta, Mantequilla de Muna ----
  "40 pieces": "40 piezas",
  "Steep the anise in a little of the warm milk for 15 minutes; that infusion is the bread's signature.":
    "Infusione el anís en un poco de la leche tibia por 15 minutos; esa infusión es la firma del pan.",
  "Mix, knead 10 minutes to a smooth dough, and prove until doubled.":
    "Mezcle, amase 10 minutos hasta una masa lisa y deje leudar hasta que doble.",
  "Knock back, shape into flat rounds about 2 cm thick, and prove again for 40 minutes.":
    "Desgasifique, forme discos planos de unos 2 cm de alto y deje leudar otros 40 minutos.",
  "Bake at 190 °C for 30 to 35 minutes until the base sounds hollow.":
    "Hornee a 190 °C por 30 a 35 minutos hasta que la base suene hueca.",
  "Crush the dried muna to a powder and beat it into softened butter with a little salt.":
    "Muela la muña seca hasta polvo e intégrela batiendo a la mantequilla pomada con un poco de sal.",
  "Serve the bread warm with the muna butter, the way a Scottish table serves a bannock.":
    "Sirva el pan tibio con la mantequilla de muña, como una mesa escocesa sirve un bannock.",
  "Bake a day ahead; the butter keeps two weeks. Refresh the bread 5 minutes at 180 °C.":
    "Hornee un día antes; la mantequilla dura dos semanas. Refresque el pan 5 minutos a 180 °C.",
  "A day wrapped. Better warm, and it is worth the oven time at the venue.":
    "Un día envuelto. Mejor tibio, y vale la pena el tiempo de horno en el local.",

  // ---- 188 Mazamorra Morada, Oat Crumble ----
  "Boil the maiz morado with pineapple skin, quince, cinnamon and clove for 40 minutes.":
    "Hierva el maíz morado con cáscara de piña, membrillo, canela y clavo por 40 minutos.",
  "Strain it and keep the quince and pineapple flesh; they go back in diced.":
    "Cuélelo y guarde la pulpa del membrillo y la piña; vuelven en cubos.",
  "Slake the cornflour in cold liquid before it goes near the pot, or you will be picking out lumps.":
    "Disuelva el chuño en líquido frío antes de acercarlo a la olla, o terminará sacando grumos.",
  "Thicken over a low heat, stirring constantly, until it coats a spoon and holds a line.":
    "Espese a fuego bajo, revolviendo sin parar, hasta que nape la cuchara y sostenga una línea.",
  "Sharpen it with lime — an unsharpened mazamorra is one flat sweet note.":
    "Acentúela con limón — una mazamorra sin acidez es una sola nota dulce y plana.",
  "Rub the oats with brown sugar and a little oil, bake until crisp, and scatter it on at the venue.":
    "Arene la avena con azúcar rubia y un poco de aceite, hornee hasta que esté crocante y espárzala en el local.",
  "Make the mazamorra two days ahead; the crumble keeps a week in a tin.":
    "Haga la mazamorra dos días antes; el crumble dura una semana en un tarro.",
  "All day chilled. Vegan, and the crumble is what stops it being one texture.":
    "Todo el día refrigerada. Vegana, y el crumble es lo que evita que sea una sola textura.",

  // ---- 189 Arroz con Leche, Whisky ----
  "Boil the rice briefly in water with the cinnamon and lemon zest before any milk goes in.":
    "Hierva el arroz brevemente en agua con la canela y la ralladura de limón antes de agregar nada de leche.",
  "That first boil is what stops the milk catching on the base of the pan later.":
    "Ese primer hervor es lo que evita que la leche se pegue al fondo de la olla más adelante.",
  "Add the milk and cook slowly, stirring often, for 35 minutes until the grains are soft and swollen.":
    "Agregue la leche y cocine despacio, revolviendo seguido, por 35 minutos hasta que los granos estén blandos e hinchados.",
  "Stir in the condensed milk and cook another 10 minutes; it will thicken a great deal as it cools.":
    "Incorpore la leche condensada y cocine otros 10 minutos; espesará muchísimo al enfriar.",
  "Take it off the heat and stir the whisky through so the spirit stays in the dish.":
    "Retire del fuego e integre el whisky para que el destilado se quede en el plato.",
  "Pot it while warm, chill, and burn a sugar top at the venue rather than in the kitchen.":
    "Envase en tibio, refrigere y queme la costra de azúcar en el local en lugar de en la cocina.",
  "Make it two days ahead. It sets firm, so beat in a little milk before potting.":
    "Hágalo dos días antes. Cuaja firme, así que integre un poco de leche batiendo antes de envasar.",
  "Needs refrigeration; two hours out. The easiest dessert here to scale to a big number.":
    "Necesita refrigeración; dos horas fuera. El postre más fácil de esta carta para escalar a un número grande.",

  // ---- 190 King Kong de Lucuma ----
  "Make the biscuit to shortbread proportions — more butter, less sugar than a Lambayeque original.":
    "Haga la galleta con proporciones de shortbread — más mantequilla y menos azúcar que un original lambayecano.",
  "Roll it thin and bake the sheets at 170 °C for 12 minutes until barely coloured.":
    "Estírela fina y hornee las láminas a 170 °C por 12 minutos hasta que apenas tomen color.",
  "Cool the sheets completely flat; a warm sheet bends and the layers will not sit true.":
    "Enfríe las láminas completamente planas; una lámina tibia se dobla y las capas no asientan derechas.",
  "Beat the lucuma pulp into two-thirds of the manjar blanco until it is thick enough to hold a line.":
    "Integre la pulpa de lúcuma a dos tercios del manjar blanco hasta que espese lo suficiente para sostener una línea.",
  "Layer biscuit, lucuma manjar, biscuit, aguaymanto preserve, biscuit, finishing with plain manjar.":
    "Arme por capas: galleta, manjar de lúcuma, galleta, conserva de aguaymanto, galleta, terminando con manjar simple.",
  "Press under a light weight overnight, then cut into bars with a hot knife wiped between cuts.":
    "Prense bajo un peso ligero toda la noche y corte en barras con un cuchillo caliente, limpiándolo entre corte y corte.",
  "Build two days ahead. The pressing is what makes it cut cleanly rather than shatter.":
    "Arme dos días antes. El prensado es lo que hace que corte limpio en vez de quebrarse.",
  "A week wrapped. Firmer than the original, and it boxes without falling apart.":
    "Una semana envuelto. Más firme que el original, y se encaja sin desarmarse.",

  // ---- 191 Champus de Chirimoya ----
  "Boil the maiz morado with the pineapple skin, quince, cinnamon and clove for 40 minutes, then strain.":
    "Hierva el maíz morado con la cáscara de piña, el membrillo, la canela y el clavo por 40 minutos y cuele.",
  "Cook the oats in the purple liquor for 20 minutes until they swell and thicken it.":
    "Cocine la avena en el líquido morado por 20 minutos hasta que hinche y lo espese.",
  "Sweeten with chancaca rather than sugar; it is what makes this taste of somewhere.":
    "Endulce con chancaca y no con azúcar; es lo que le da sabor a un lugar concreto.",
  "Dice the cooked quince and pineapple and fold them back in whole.":
    "Corte en cubos el membrillo y la piña cocidos e intégrelos enteros de vuelta.",
  "Scoop the chirimoya at the last moment, picking out every seed, and fold it through off the heat.":
    "Saque la pulpa de la chirimoya al último momento, retirando todas las pepas, e intégrela fuera del fuego.",
  "Serve warm. Champus is a cold-night drink-and-pudding and it loses the point chilled.":
    "Sirva tibio. El champús es bebida y postre de noche fría, y frío pierde todo el sentido.",
  "Make the base two days ahead. Chirimoya goes in at the venue or it browns.":
    "Haga la base dos días antes. La chirimoya entra en el local o se oxida.",
  "Two hours held warm. Vegan, and a winter product rather than a year-round one.":
    "Dos horas mantenido tibio. Vegano, y un producto de invierno más que de todo el año.",

  // ---- 1 Haggis Bonbons (yields, notes, ahead/holds) ----
  "50 bonbons": "50 bonbons",
  "heart and liver; ask the butcher to trim and mince coarse":
    "corazón e hígado; pida al carnicero que los limpie y muela grueso",
  "avena entera, not instant": "avena entera, no instantánea",
  "the flavour that reads as Scottish; do not skip":
    "el sabor que se lee como escocés; no lo omita",
  "for the crumbing station": "para la estación de apanado",
  "mayonnaise, huacatay paste, lime, garlic": "mayonesa, pasta de huacatay, limón, ajo",
  "The mix keeps 3 days chilled. Crumbed and uncooked they freeze a month — fry from frozen, add 90 seconds.":
    "La mezcla dura 3 días refrigerada. Apanados y crudos se congelan un mes — fría desde congelado y agregue 90 segundos.",
  "Crisp for about 40 minutes on a rack. In a closed box they go soft in 15, so transport them uncovered and box at the venue.":
    "Crocantes unos 40 minutos sobre rejilla. En caja cerrada se ablandan en 15, así que transpórtelos destapados y encájelos en el local.",
  "Above 200 pieces the oats hydrate unevenly in one pot. Cook the base in batches of 2 kg or it catches.":
    "Por encima de 200 piezas la avena se hidrata disparejo en una sola olla. Cocine la base en tandas de 2 kg o se pega.",

  // ---- 2 Morcilla & Apple Empanadas (yields, notes, ahead/holds) ----
  "50 empanadas": "50 empanadas",
  "buy from a local bakery; cheaper and better than making it":
    "cómprela en una panadería del barrio; más barato y mejor que hacerla",
  "ask for it made with extra oats and white pepper":
    "pida que la preparen con avena extra y pimienta blanca",
  "firm apple that holds its shape": "manzana firme que aguanta su forma",
  "for the chutney": "para el chutney",
  "egg wash": "para pincelar con huevo",
  "Assemble and freeze raw on trays, then bag. Bake from frozen at 180 °C, 25 minutes.":
    "Arme y congele crudas en bandejas, luego embólselas. Hornee desde congelado a 180 °C, 25 minutos.",
  "Good warm or at room temperature, which is what makes them a drop-off staple. Two hours in a box without suffering.":
    "Buenas tibias o a temperatura ambiente, y por eso son un básico de entrega. Dos horas en caja sin sufrir.",

  // ---- 183 Huancaina Escocesa ----
  "Boil the potatoes whole and unpeeled, then peel and slice them thick while still warm.":
    "Hierva las papas enteras y con cáscara, luego pélelas y córtelas gruesas mientras siguen tibias.",

  // ---- 192 Arbroath Smokie Pate, Rocoto ----
  "ask for it smoked hard; a light smoke disappears under the butter":
    "pídala bien ahumada; un ahumado suave desaparece bajo la mantequilla",
  "softened, not melted": "pomada, no derretida",
  "deseeded; one if the batch is going to a mixed room":
    "sin pepas; use uno solo si la tanda va a una sala mixta",
  "juice and zest": "jugo y ralladura",
  "the thin cut; the thick one fights the pâté":
    "el corte delgado; el grueso pelea con el paté",
  "Flake the trout by hand and pick it hard for pin bones — a bone in a canapé is the only unforgivable one.":
    "Desmenuce la trucha a mano y revísela a conciencia buscando espinas — una espina en un bocadito es la única imperdonable.",
  "Beat the butter and cream cheese together until pale, then fold the trout through in three additions.":
    "Bata la mantequilla con el queso crema hasta que palidezcan e integre la trucha en tres adiciones.",
  "Blitz a third of the mix smooth and stir it back in. That gives body without losing the flake.":
    "Licúe un tercio de la mezcla hasta que quede lisa y devuélvala al conjunto. Eso da cuerpo sin perder la lámina.",
  "Add rocoto, lime juice and zest, white pepper and mace. Taste for salt last: the smoke carries a lot of it already.":
    "Agregue rocoto, jugo y ralladura de limón, pimienta blanca y macis. Pruebe la sal al final: el ahumado ya trae bastante.",
  "Pipe or quenelle 15 g onto each oatcake no more than 40 minutes before service.":
    "Ponga 15 g con manga o en quenelle sobre cada oatcake no más de 40 minutos antes del servicio.",
  "The pâté keeps 4 days chilled and improves on day two. Do not freeze it — the butter splits and the trout goes grainy.":
    "El paté dura 4 días refrigerado y mejora al segundo día. No lo congele — la mantequilla se corta y la trucha se pone granulosa.",
  "Assembled, 40 minutes before the oatcake softens. Carry the pâté and the oatcakes separately and build at the venue.":
    "Armado, 40 minutos antes de que el oatcake se ablande. Lleve el paté y los oatcakes por separado y arme en el local.",
  "Above 4 kg the butter warms faster than you can beat it. Work in 2 kg batches over ice.":
    "Por encima de 4 kg la mantequilla se calienta más rápido de lo que uno la bate. Trabaje en tandas de 2 kg sobre hielo.",

  // ---- 193 Partan Bree Shots ----
  "50 shots": "50 vasitos",
  "brown and white together; the brown is where the flavour is":
    "carne oscura y blanca juntas; en la oscura está el sabor",
  "ask the stall to keep the shells — this is the stock":
    "pida al puesto que le guarde los caparazones — ahí está el fondo",
  "the traditional thickener; no flour goes near a partan bree":
    "el espesante tradicional; a un partan bree no se le acerca la harina",
  "kernels only, blanched": "solo los granos, blanqueados",
  "for the oil that finishes it": "para el aceite que lo termina",
  "Roast the crab shells hard at 200 °C for 20 minutes, then simmer them in the milk with the onion for 30 minutes.":
    "Tueste bien los caparazones de cangrejo a 200 °C por 20 minutos y cocínelos a fuego lento en la leche con la cebolla por 30 minutos.",
  "Strain that milk through muslin — twice, because shell grit is the fault a shot glass shows up immediately.":
    "Cuele esa leche por gasa — dos veces, porque la arenilla del caparazón es el defecto que un vasito delata de inmediato.",
  "Cook the rice in the crab milk until it collapses, about 20 minutes, then blitz the whole lot smooth.":
    "Cocine el arroz en la leche de cangrejo hasta que se deshaga, unos 20 minutos, y licúe todo hasta que quede liso.",
  "Fold in the brown crab meat, blitz again, and pass through a sieve. Stir the white meat through whole.":
    "Integre la carne oscura de cangrejo, licúe otra vez y pase por colador. Incorpore la carne blanca entera.",
  "Warm the cream in and correct with white pepper and salt. It should coat a spoon and still pour.":
    "Incorpore la crema tibia y corrija con pimienta blanca y sal. Debe napar la cuchara y aun así verterse.",
  "Blitz rocoto with the olive oil and let it settle; float a few drops on each shot with blanched choclo.":
    "Licúe rocoto con el aceite de oliva y déjelo asentar; haga flotar unas gotas en cada vasito junto con choclo blanqueado.",
  "The soup base keeps 3 days chilled or a month frozen. The white meat goes in on the day it is served, never before.":
    "La base de la sopa dura 3 días refrigerada o un mes congelada. La carne blanca entra el día en que se sirve, nunca antes.",
  "Two hours in a bain-marie at 65 °C. Above that it splits, and once split it does not come back.":
    "Dos horas en baño maría a 65 °C. Por encima se corta, y una vez cortada no vuelve.",
  "Sieving is the bottleneck, not cooking. Budget an extra 20 minutes per 5 litres.":
    "Colar es el cuello de botella, no cocinar. Calcule 20 minutos adicionales por cada 5 litros.",

  // ---- 194 Skirlie Mushroom Caps ----
  "50 caps": "50 sombreros",
  "50 flat field mushrooms about 6 cm across; stalks kept for the stuffing":
    "50 champiñones planos de unos 6 cm de diámetro; guarde los tallos para el relleno",
  "cooked and cooled": "cocida y fría",
  "grated, for the top": "rallado, para la superficie",
  "Toast the oatmeal dry until it smells of biscuit, then set it aside. This is the whole trick of a skirlie.":
    "Tueste la avena en seco hasta que huela a galleta y resérvela. En eso consiste todo el truco de un skirlie.",
  "Melt the butter and cook the onion and chopped mushroom stalks slowly until sweet and dry, 15 minutes.":
    "Derrita la mantequilla y cocine la cebolla y los tallos de champiñón picados despacio hasta que estén dulces y secos, 15 minutos.",
  "Stir in the ají amarillo and cook it out two minutes so it stops tasting raw.":
    "Incorpore el ají amarillo y cocínelo dos minutos para que deje de saber crudo.",
  "Add the toasted oatmeal and the cooked quinoa off the heat; it should be crumbly, never a paste.":
    "Agregue la avena tostada y la quinua cocida fuera del fuego; debe quedar desmoronable, nunca una pasta.",
  "Season hard with white pepper and salt, then fold the parsley through.":
    "Sazone con fuerza con pimienta blanca y sal, e integre el perejil.",
  "Pack 25 g into each cap, scatter paria over, and bake at 190 °C for 12 minutes until the tops catch.":
    "Rellene cada sombrero con 25 g, esparza paria encima y hornee a 190 °C por 12 minutos hasta que las superficies se doren.",
  "Stuff the caps a day ahead and keep them chilled on trays. The skirlie itself keeps 3 days and reheats dry in a pan.":
    "Rellene los sombreros un día antes y manténgalos refrigerados en bandejas. El skirlie en sí dura 3 días y se recalienta en seco en una sartén.",
  "Best in the first 30 minutes. After an hour the mushroom weeps and the base goes soft, so bake in waves.":
    "Mejores en los primeros 30 minutos. Tras una hora el champiñón suelta agua y la base se ablanda, así que hornee por tandas.",
  "Two trays at a time, no more. A crowded oven steams the caps instead of roasting them.":
    "Dos bandejas a la vez, no más. Un horno saturado cocina los sombreros al vapor en vez de asarlos.",

  // ---- 195 Venison & Juniper Sausage Rolls ----
  "shoulder, coarse minced; ask the butcher, it is too lean to mince at home":
    "paleta, molida gruesa; pídalo al carnicero, es demasiado magra para molerla en casa",
  "minced with the alpaca; without this fat the roll is sawdust":
    "molida junto con la alpaca; sin esta grasa el rollo es aserrín",
  "toasted": "tostada",
  "crushed in a mortar, not ground to dust":
    "machacadas en mortero, no molidas a polvo",
  "Sweat the onion until soft and completely cold before it meets the meat, or the fat smears.":
    "Sude la cebolla hasta ablandarla y enfríela por completo antes de que toque la carne, o la grasa se embarra.",
  "Mix alpaca, pork belly, onion, oatmeal, juniper, mace and pepper. Fry a spoonful and taste it before you roll anything.":
    "Mezcle alpaca, panceta, cebolla, avena, enebro, macis y pimienta. Fría una cucharada y pruébela antes de enrollar nada.",
  "Roll the pastry to 3 mm and cut long strips 12 cm wide. Pipe the filling down one side in a 3 cm rope.":
    "Estire la masa a 3 mm y corte tiras largas de 12 cm de ancho. Ponga el relleno con manga a lo largo de un lado en un cordón de 3 cm.",
  "Egg wash the far edge, roll, and seal seam-side down. Chill the logs 30 minutes so they cut cleanly.":
    "Pincele con huevo el borde opuesto, enrolle y selle con la unión hacia abajo. Refrigere los rollos 30 minutos para que corten limpio.",
  "Cut into 5 cm rolls, snip the tops twice, egg wash and bake at 200 °C for 22–25 minutes.":
    "Corte en piezas de 5 cm, haga dos cortes en la superficie, pincele con huevo y hornee a 200 °C por 22–25 minutos.",
  "Freeze the uncooked logs up to a month. Bake from frozen at 190 °C, adding 10 minutes, and they come out better than fresh.":
    "Congele los rollos crudos hasta un mes. Hornee desde congelado a 190 °C agregando 10 minutos, y salen mejores que frescos.",
  "Crisp for an hour on a rack. Boxed hot they steam themselves soft, so cool 10 minutes before the lid goes on.":
    "Crocantes una hora sobre rejilla. Encajados calientes se ablandan con su propio vapor, así que enfríe 10 minutos antes de tapar.",
  "Alpaca is lean enough that overmixing turns it rubbery. Mix each 3 kg batch by hand and stop early.":
    "La alpaca es tan magra que mezclarla de más la vuelve gomosa. Mezcle cada tanda de 3 kg a mano y pare temprano.",

  // ---- 196 Musselburgh Pie Minis ----
  "40 pies": "40 pies",
  "boned and diced small": "deshuesado y cortado en cubos chicos",
  "the roe left on; check the veda before you order":
    "con el coral; revise la veda antes de hacer el pedido",
  "made with lard; a shortcrust collapses at this size":
    "hecha con manteca; una masa quebrada se desploma a este tamaño",
  "Brown the beef hard in batches. A grey pan here gives a grey pie, and no amount of stout fixes it.":
    "Dore la carne con fuerza por tandas. Una sartén gris aquí da un pie gris, y no hay cerveza negra que lo arregle.",
  "Sweat the onion in the same pan, dust with flour, then deglaze with the cerveza negra and scrape everything up.":
    "Sude la cebolla en la misma olla, espolvoree harina y desglase con la cerveza negra raspando todo el fondo.",
  "Braise covered at 150 °C for 2 hours until the beef pulls apart, then cool completely and set with its own jelly.":
    "Brasee tapado a 150 °C por 2 horas hasta que la carne se deshaga, enfríe por completo y deje cuajar con su propia gelatina.",
  "Raise the crusts around a 5 cm dolly while the pastry is still warm — cold hot-water crust will not stretch.":
    "Levante las paredes de masa alrededor de un molde de 5 cm mientras la masa sigue tibia — la masa de agua caliente fría no estira.",
  "Fill with the cold beef, press one scallop into each, lid, crimp and cut a steam hole.":
    "Rellene con la carne fría, hunda una concha de abanico en cada uno, tape, repulgue y haga un respiradero.",
  "Egg wash and bake at 190 °C for 35–40 minutes. The scallop cooks in the pie, not before it.":
    "Pincele con huevo y hornee a 190 °C por 35–40 minutos. La concha se cocina dentro del pie, no antes.",
  "The braise keeps 3 days or freezes a month. Raise and fill on the day: a filled raw pie standing overnight goes soggy at the base.":
    "El braseado dura 3 días o se congela un mes. Levante y rellene el mismo día: un pie crudo relleno que pasa la noche se aguada en la base.",
  "Warm for 90 minutes in a covered box, and they are honestly better at room temperature than hot.":
    "Tibios por 90 minutos en caja tapada, y sinceramente están mejor a temperatura ambiente que calientes.",
  "Raising crusts is the slow step — about 40 an hour by hand. Two people or a smaller order.":
    "Levantar las paredes es el paso lento — unos 40 por hora a mano. Dos personas o un pedido más chico.",

  // ---- 197 Mealie Pudding Bites, Aji Amarillo ----
  "60 bites": "60 bocaditos",
  "the sweetness is doing all the work; do not skimp":
    "el dulzor hace todo el trabajo; no escatime",
  "mayonnaise, ají amarillo paste, lime": "mayonesa, pasta de ají amarillo, limón",
  "Toast the pinhead oatmeal dry until it darkens a shade and smells nutty. This is the only flavour step there is.":
    "Tueste la avena entera en seco hasta que oscurezca un tono y huela a nuez. Es el único paso de sabor que hay.",
  "Sweat the onion in the suet over a low heat for 25 minutes until it is sweet and almost jam.":
    "Sude la cebolla en el sebo a fuego bajo por 25 minutos hasta que esté dulce y casi como mermelada.",
  "Stir in the oatmeal, pepper and mace, then the hot stock. Cook 15 minutes until it thickens and pulls off the pan.":
    "Incorpore la avena, la pimienta y el macis, y luego el caldo caliente. Cocine 15 minutos hasta que espese y se despegue de la olla.",
  "Spread on a tray, chill 4 hours, then roll into 20 g balls.":
    "Extienda en una bandeja, refrigere 4 horas y bolee de 20 g.",
  "Flour, egg and panko, then fry at 175 °C for 3 minutes until deep gold. Serve with the ají amarillo mayonnaise.":
    "Harina, huevo y panko, luego fría a 175 °C por 3 minutos hasta dorado profundo. Sirva con la mayonesa de ají amarillo.",
  "The mix keeps 4 days chilled; crumbed and raw they freeze a month and fry straight from the freezer.":
    "La mezcla dura 4 días refrigerada; apanados y crudos se congelan un mes y se fríen directo del congelador.",
  "Crisp for 40 minutes on a rack. Suet sets hard as it cools, so serve these warm or they go waxy.":
    "Crocantes 40 minutos sobre rejilla. El sebo cuaja duro al enfriar, así que sírvalos tibios o quedan cerosos.",
  "Cook the base in 3 kg batches. Any bigger and the oatmeal on the bottom catches before the top swells.":
    "Cocine la base en tandas de 3 kg. Más grande y la avena del fondo se pega antes de que la de arriba hinche.",

  // ---- 198 Haggis, Neeps & Tatties ----
  "bought from the butcher who makes it to the brief, or built from the dish 1 base":
    "comprado al carnicero que lo hace según el encargo, o armado con la base del plato 1",
  "nabo; peeled weight": "nabo; peso ya pelado",
  "Steam or bake the haggis wrapped in foil at 160 °C for 75 minutes. Never boil it hard; the skin bursts every time.":
    "Cocine el haggis al vapor o al horno envuelto en papel aluminio a 160 °C por 75 minutos. Nunca lo hierva fuerte; la tripa revienta siempre.",
  "Boil the turnip in salted water until it gives completely, then drain and dry it out in the pan for two minutes.":
    "Hierva el nabo en agua con sal hasta que ceda por completo, escurra y séquelo en la olla por dos minutos.",
  "Mash the turnip with a third of the butter and a heavy hand of white pepper. It should be coarse, not smooth.":
    "Haga puré el nabo con un tercio de la mantequilla y una mano generosa de pimienta blanca. Debe quedar grueso, no liso.",
  "Steam the papa amarilla rather than boiling it — it is wet enough already — then rice it with butter and cream.":
    "Cocine la papa amarilla al vapor en vez de hervirla — ya tiene bastante humedad — y páselas por prensapuré con mantequilla y crema.",
  "Reduce the whisky by half, add stock and chancaca, and simmer to a sauce that just coats the back of a spoon.":
    "Reduzca el whisky a la mitad, agregue caldo y chancaca, y cocine hasta una salsa que apenas nape el dorso de la cuchara.",
  "Plate a scoop of each, split the haggis at the table if it is a whole one, and pour the sauce over at the pass.":
    "Sirva una porción de cada uno, abra el haggis en la mesa si es entero, y bañe con la salsa en el pase.",
  "Both mashes hold 2 days chilled and reheat in a bain-marie. The sauce keeps a week and reheats without splitting.":
    "Ambos purés aguantan 2 días refrigerados y se recalientan a baño maría. La salsa dura una semana y se recalienta sin cortarse.",
  "An hour in hot cupboards. The tatties skin over after that, so cover them with a butter paper.":
    "Una hora en gabinete caliente. Después de eso el puré forma película, así que cúbralo con papel enmantequillado.",
  "Mashes are what slow this down at 200 covers. Rice the potato into hotel pans and bain-marie them, never a pot.":
    "Los purés son lo que frena este plato a 200 cubiertos. Prense la papa directo en bandejas gastronorm y manténgalas a baño maría, nunca en olla.",

  // ---- 199 Vegetarian Haggis, Quinoa ----
  "the dominant spice in any haggis; do not treat it as background":
    "la especia dominante en cualquier haggis; no la trate como fondo",
  "Toast the oatmeal dry, then toast the quinoa and kiwicha the same way. Three separate pans, three different smells.":
    "Tueste la avena en seco, y luego la quinua y la kiwicha del mismo modo. Tres sartenes separadas, tres olores distintos.",
  "Sweat the onion and grated carrot in the oil for 20 minutes until they are sweet and have given up their water.":
    "Sude la cebolla y la zanahoria rallada en el aceite por 20 minutos hasta que estén dulces y hayan soltado su agua.",
  "Add the lentils and stock and simmer 30 minutes until the lentils are soft but still whole.":
    "Agregue las lentejas y el caldo y cocine a fuego lento 30 minutos hasta que las lentejas estén blandas pero enteras.",
  "Fold in the grains and oatmeal off the heat, then the spices. It should be loose; it tightens as it stands.":
    "Integre los granos y la avena fuera del fuego, y luego las especias. Debe quedar floja; se aprieta al reposar.",
  "Press into lined trays 5 cm deep, bake at 170 °C for 30 minutes, and rest an hour before cutting.":
    "Presione en bandejas forradas de 5 cm de alto, hornee a 170 °C por 30 minutos y repose una hora antes de cortar.",
  "Serve with turnip mashed in oil rather than butter, which keeps the whole plate vegan.":
    "Sirva con nabo hecho puré en aceite en vez de mantequilla, lo que mantiene vegano todo el plato.",
  "The tray keeps 4 days chilled and cuts far better cold than warm. It freezes a month, portioned.":
    "La bandeja dura 4 días refrigerada y corta mucho mejor fría que tibia. Se congela un mes, ya porcionada.",
  "Ninety minutes covered. Drier than the meat version, so send a jug of stock gravy with it.":
    "Noventa minutos tapado. Más seco que la versión con carne, así que mande una jarra de salsa de caldo con él.",
  "It is the toasting that scales badly, not the cooking. Do the grains in a low oven on trays above 5 kg.":
    "Lo que escala mal es el tostado, no la cocción. Por encima de 5 kg tueste los granos en horno bajo sobre bandejas.",

  // ---- 200 Beef Olives, Aji Panca ----
  "cut in 90 g slices and beaten thin between sheets":
    "cortado en láminas de 90 g y aplanado entre dos hojas",
  "Make the stuffing first: sweat half the onion in the suet, stir in the toasted oatmeal, mace and pepper, and cool it.":
    "Haga primero el relleno: sude la mitad de la cebolla en el sebo, integre la avena tostada, el macis y la pimienta, y enfríelo.",
  "Lay each beaten slice flat, put 30 g of stuffing at one end, roll and tie once with string.":
    "Extienda cada lámina aplanada, ponga 30 g de relleno en un extremo, enrolle y ate una vez con pabilo.",
  "Brown the rolls hard on all sides in batches and lift them out. Crowding the pan is what makes them grey.":
    "Dore los rollos con fuerza por todos lados en tandas y retírelos. Saturar la olla es lo que los deja grises.",
  "Sweat the rest of the onion, add the ají panca and cook it out, dust with flour, then wine and stock.":
    "Sude el resto de la cebolla, agregue el ají panca y cocínelo, espolvoree harina y luego vino y caldo.",
  "Return the rolls, cover, and braise at 150 °C for two hours until a knife goes through with no resistance.":
    "Devuelva los rollos, tape y brasee a 150 °C por dos horas hasta que el cuchillo entre sin resistencia.",
  "Rest, cut the strings, and reduce the braising liquor by a third before it goes back over.":
    "Repose, corte los pabilos y reduzca el líquido del braseado en un tercio antes de volver a bañarlos.",
  "Braise a day ahead and cool in the liquor — it is genuinely better on day two. Freezes a month in its sauce.":
    "Brasee un día antes y enfríe dentro del líquido — de verdad está mejor al segundo día. Se congela un mes en su salsa.",
  "Two hours in the sauce at 70 °C. Out of the sauce they dry in twenty minutes, so never hold them plated.":
    "Dos horas en la salsa a 70 °C. Fuera de la salsa se secan en veinte minutos, así que nunca los mantenga emplatados.",
  "Tying is the labour: about 60 rolls an hour. Cost the extra hands into anything above 40 portions.":
    "Atar es el trabajo: unos 60 rollos por hora. Incluya manos adicionales en el costo de cualquier pedido de más de 40 porciones.",

  // ---- 201 Finnan Haddie, Mustard Cream ----
  "check the veda before ordering; September and October are closed":
    "revise la veda antes de pedir; setiembre y octubre están cerrados",
  "for the overnight cure": "para la curación de toda la noche",
  "for the cure": "para la curación",
  "Cure the corvina in salt and sugar for 4 hours, rinse, dry, and cold-smoke it 40 minutes over oak dust.":
    "Cure la corvina en sal y azúcar por 4 horas, enjuague, seque y ahúmela en frío 40 minutos sobre aserrín de roble.",
  "Poach the smoked fillets gently in the milk with the leek greens for 8 minutes, then lift them out and keep them warm.":
    "Escalfe los filetes ahumados suavemente en la leche con la parte verde del poro por 8 minutos, retírelos y manténgalos tibios.",
  "Strain the poaching milk, reduce it by a third, then add cream and both mustards and simmer to a sauce.":
    "Cuele la leche del escalfado, redúzcala en un tercio, agregue crema y ambas mostazas y cocine hasta obtener una salsa.",
  "Sweat the leek whites in butter until soft with no colour and fold them through the sauce.":
    "Sude la parte blanca del poro en mantequilla hasta ablandarla sin tomar color e intégrela a la salsa.",
  "Steam and crush the papa amarilla with butter — crushed, not mashed, so the sauce has somewhere to sit.":
    "Cocine al vapor y aplaste la papa amarilla con mantequilla — aplastada, no en puré, para que la salsa tenga dónde asentarse.",
  "Plate fish on potato, sauce over, parsley on top. Do not sauce until the plate is going out.":
    "Sirva el pescado sobre la papa, la salsa encima y el perejil arriba. No salsee hasta que el plato esté saliendo.",
  "Smoke the fish a day ahead; it is better rested. The sauce holds 3 days and reheats without splitting if you go slowly.":
    "Ahúme el pescado un día antes; queda mejor reposado. La salsa aguanta 3 días y se recalienta sin cortarse si va despacio.",
  "Twenty minutes once sauced, and no longer. This is the least forgiving plate on the list and it is worth saying so to the client.":
    "Veinte minutos una vez salseado, y ni un minuto más. Es el plato menos indulgente de la carta y vale la pena decírselo al cliente.",
  "The smoker is the ceiling, not the stove. Above 30 portions smoke in two sittings the day before.":
    "El ahumador es el techo, no la cocina. Por encima de 30 porciones ahúme en dos tandas el día anterior.",

  // ---- 202 Whole Poached Salmon, Muna ----
  "two fish about 4 kg each, gutted and scaled, heads on":
    "dos pescados de unos 4 kg cada uno, eviscerados y escamados, con cabeza",
  "in place of the dill a Scottish kitchen would use":
    "en lugar del eneldo que usaría una cocina escocesa",
  "sliced paper thin for the scales": "cortado finísimo para simular las escamas",
  "Build the court-bouillon and simmer it 20 minutes before the fish goes near it, or the vegetables taste raw.":
    "Arme el court-bouillon y cocínelo a fuego lento 20 minutos antes de acercarle el pescado, o las verduras saben crudas.",
  "Lower the salmon in, bring it back to a bare tremble, then take the pot off the heat entirely.":
    "Sumerja el salmón, vuelva a llevarlo a un temblor apenas perceptible y retire la olla del fuego por completo.",
  "Leave it to cool in the liquor for two hours. It cooks through on residual heat and never overcooks that way.":
    "Déjelo enfriar en el líquido por dos horas. Se cocina con el calor residual y así nunca se pasa.",
  "Lift it out on the cloth, peel the skin from the top side, and scrape the brown line away with the back of a knife.":
    "Levántelo con el paño, retire la piel del lado superior y raspe la línea marrón con el dorso de un cuchillo.",
  "Tile the cucumber over the flesh from tail to head so it reads as scales, and press it down lightly.":
    "Cubra la carne con pepino montado de la cola a la cabeza para que se lea como escamas, y presione ligeramente.",
  "Serve cold with huacatay aioli, muña scattered over and lime on the side.":
    "Sirva frío con alioli de huacatay, muña esparcida encima y limón al lado.",
  "Poach the day before and keep it whole and covered. Skin and dress it on the morning of the event, never earlier.":
    "Escálfelo el día anterior y manténgalo entero y tapado. Pélelo y decórelo la mañana del evento, nunca antes.",
  "Four hours on a buffet under 20 °C. Above that it is off the table at two hours and that is a hard limit.":
    "Cuatro horas en buffet por debajo de 20 °C. Por encima de esa temperatura sale de la mesa a las dos horas, y ese límite es firme.",
  "A fish kettle takes one salmon. Two fish means two sittings or a deep roasting tray and foil.":
    "Una pescadera acepta un salmón. Dos pescados significan dos tandas o una bandeja honda de horno con papel aluminio.",

  // ---- 203 Venison & Alpaca Pie, Juniper ----
  "shoulder or leg, diced 4 cm": "paleta o pierna, en cubos de 4 cm",
  "the fat alpaca does not have": "la grasa que la alpaca no tiene",
  "for the suet crust": "para la masa de sebo",
  "Render the bacon, then brown the alpaca in that fat in small batches. Lean meat catches fast, so watch it.":
    "Derrita el tocino y dore la alpaca en esa grasa en tandas chicas. La carne magra se pega rápido, así que no la pierda de vista.",
  "Sweat onion and carrot, dust with flour, add stout and stock, and scrape the base clean.":
    "Sude cebolla y zanahoria, espolvoree harina, agregue cerveza negra y caldo, y raspe el fondo hasta dejarlo limpio.",
  "Return the meat with juniper and bay, cover, and braise at 150 °C for three hours until it gives to a spoon.":
    "Devuelva la carne con el enebro y el laurel, tape y brasee a 150 °C por tres horas hasta que ceda a la cuchara.",
  "Cool the braise completely. A warm filling melts the suet crust before it ever reaches the oven.":
    "Enfríe el braseado por completo. Un relleno tibio derrite la masa de sebo antes de que llegue siquiera al horno.",
  "Rub suet into flour with cold water to a rough dough, roll to 5 mm, and lid the filled dishes.":
    "Arene el sebo con la harina y agua fría hasta una masa rústica, estire a 5 mm y tape las fuentes ya rellenas.",
  "Egg wash, cut a vent, and bake at 190 °C for 35 minutes until the crust is set and pale gold.":
    "Pincele con huevo, haga un respiradero y hornee a 190 °C por 35 minutos hasta que la masa cuaje y esté dorada clara.",
  "The braise keeps 3 days or freezes a month. Lid and bake on the day; a raw suet crust standing overnight goes grey.":
    "El braseado dura 3 días o se congela un mes. Tape y hornee el mismo día; una masa de sebo cruda que pasa la noche se pone gris.",
  "An hour covered. Suet crust softens rather than going hard, so it forgives a slow room better than shortcrust.":
    "Una hora tapado. La masa de sebo se ablanda en vez de endurecerse, así que perdona una sala lenta mejor que una masa quebrada.",
  "Alpaca varies more than beef between animals. Taste the braise at two hours and give it another hour if it needs it.":
    "La alpaca varía más que la res de un animal a otro. Pruebe el braseado a las dos horas y dele una hora más si la necesita.",

  // ---- 204 Smokie & Choclo Fishcakes ----
  "floury, steamed and dried out": "harinosa, cocida al vapor y bien seca",
  "kernels blanched, half of them blitzed coarse for the crust":
    "granos blanqueados, la mitad procesados grueso para la costra",
  "zest": "ralladura",
  "Steam the potato in its skin, peel it hot, and rice it. A boiled potato makes a wet cake that will not hold.":
    "Cocine la papa al vapor con cáscara, pélela en caliente y páselas por prensapuré. Una papa hervida da una torta húmeda que no se sostiene.",
  "Dry the riced potato in a low oven for ten minutes. This is the step everyone skips and it is the one that matters.":
    "Seque la papa prensada en horno bajo por diez minutos. Es el paso que todos se saltan y es el que importa.",
  "Fold in the flaked trout, blanched choclo, spring onion, parsley, zest and white pepper. Do not beat it.":
    "Integre la trucha desmenuzada, el choclo blanqueado, la cebolla china, el perejil, la ralladura y la pimienta blanca. No lo bata.",
  "Shape 100 g cakes, chill an hour on trays, then flour, egg and crumb them in panko cut with the blitzed choclo.":
    "Forme tortas de 100 g, refrigere una hora en bandejas y páselas por harina, huevo y panko mezclado con el choclo procesado.",
  "Fry at 175 °C for 4 minutes a side until the crust is deep gold, and finish in the oven if they are thick.":
    "Fría a 175 °C por 4 minutos por lado hasta que la costra esté dorada oscura, y termine en el horno si son gruesas.",
  "Shape and crumb a day ahead, or freeze them raw for a month and fry from frozen with four minutes added.":
    "Forme y apane un día antes, o congélelas crudas por un mes y fría desde congelado agregando cuatro minutos.",
  "Forty minutes crisp on a rack, an hour warm in a low oven. Never stack them; the weight collapses the crust.":
    "Cuarenta minutos crocantes sobre rejilla, una hora tibias en horno bajo. Nunca las apile; el peso hunde la costra.",
  "Fry in batches of eight. A dozen at once drops the oil below 160 °C and the crust drinks it.":
    "Fría en tandas de ocho. Una docena a la vez baja el aceite por debajo de 160 °C y la costra lo absorbe.",

  // ---- 205 Bashed Neeps, Chancaca Butter ----
  "nabo; peeled weight, cut in even 3 cm chunks":
    "nabo; peso ya pelado, cortado en trozos parejos de 3 cm",
  "grated, melted into the butter": "rallada, derretida en la mantequilla",
  "Boil the turnip in well-salted water until it collapses under a spoon — undercooked neeps will not bash smooth.":
    "Hierva el nabo en agua bien salada hasta que se deshaga bajo la cuchara — un nabo poco cocido no se machaca parejo.",
  "Drain hard and return to the dry pan over heat for two minutes to steam off the water it is holding.":
    "Escurra bien y devuelva a la olla seca sobre el fuego por dos minutos para evaporar el agua que retiene.",
  "Melt the chancaca into the butter over a low heat until it dissolves completely, then beat it in.":
    "Derrita la chancaca en la mantequilla a fuego bajo hasta que se disuelva por completo, e incorpórela batiendo.",
  "Bash with a masher, not a blender. A blended neep goes gluey and loses the whole point of the texture.":
    "Machaque con prensapuré, no con licuadora. Un nabo licuado se vuelve gomoso y pierde todo el sentido de la textura.",
  "Season with a heavier hand of white pepper than feels right, taste, and season again.":
    "Sazone con más pimienta blanca de la que parece correcta, pruebe y vuelva a sazonar.",
  "Two days chilled, and it reheats in a bain-marie without any loss. It also freezes a month.":
    "Dos días refrigerado, y se recalienta a baño maría sin pérdida alguna. También se congela un mes.",
  "Two hours in a bain-marie covered. Uncovered it skins over in twenty minutes.":
    "Dos horas en baño maría tapado. Destapado forma película en veinte minutos.",
  "Above 10 kg boil in two pots. One overloaded pot cooks the outside to mush before the middle gives.":
    "Por encima de 10 kg hierva en dos ollas. Una sola olla sobrecargada deshace el exterior antes de que el centro ceda.",

  // ---- 206 Kale & Oat Crumb Gratin ----
  "stripped from the stalk; that is about 6 kg on the stem":
    "deshojado del tallo; eso equivale a unos 6 kg con tallo",
  "grated": "rallado",
  "for the crumb": "para el crumble",
  "Blanch the kale 3 minutes, refresh in cold water, and squeeze it dry hard. Wet kale waters the gratin down.":
    "Blanquee el kale 3 minutos, refresque en agua fría y exprímalo con fuerza. El kale húmedo aguada el gratén.",
  "Make a béchamel with butter, flour and milk, cook it out ten minutes, then add cream, nutmeg and pepper.":
    "Haga una bechamel con mantequilla, harina y leche, cocínela diez minutos y agregue crema, nuez moscada y pimienta.",
  "Melt two-thirds of the paria into the sauce and fold the kale through so every leaf is coated.":
    "Funda dos tercios del paria en la salsa e integre el kale para que cada hoja quede cubierta.",
  "Rub the cold butter into the oatmeal with the rest of the paria until it clumps like coarse gravel.":
    "Arene la mantequilla fría con la avena y el resto del paria hasta que se apelmace como grava gruesa.",
  "Spread the kale into trays, crumb over, and bake at 190 °C for 30 minutes until the top is set and brown.":
    "Extienda el kale en bandejas, cubra con el crumble y hornee a 190 °C por 30 minutos hasta que la superficie cuaje y dore.",
  "Build the trays a day ahead unbaked and keep them cold. Baked, it reheats at 170 °C for 20 minutes without suffering.":
    "Arme las bandejas un día antes sin hornear y manténgalas frías. Ya horneado, se recalienta a 170 °C por 20 minutos sin sufrir.",
  "Ninety minutes covered, and it is one of the few greens that survives a van. That is why it is on the list.":
    "Noventa minutos tapado, y es de las pocas verduras que sobrevive una camioneta. Por eso está en la carta.",
  "Squeezing kale dry is the slow step — about 4 kg an hour by hand. Budget for it.":
    "Exprimir el kale es el paso lento — unos 4 kg por hora a mano. Considérelo en el presupuesto.",

  // ---- 207 Ayrshire Potatoes, Huacatay Butter ----
  "small ones, skins on, scrubbed not peeled":
    "chicas, con cáscara, cepilladas y no peladas",
  "paste or fresh leaves blitzed with a little oil":
    "en pasta o en hojas frescas procesadas con un poco de aceite",
  ...
  "Beat the huacatay, lime zest and juice into the softened butter and leave it at room temperature to loosen.":
    "Integre batiendo el huacatay, la ralladura y el jugo de limón a la mantequilla pomada y déjela a temperatura ambiente para que se afloje.",
  "Boil the potatoes in heavily salted water — as salty as soup — until a knife slides in without pressure.":
    "Hierva las papas en agua bien salada — tan salada como una sopa — hasta que el cuchillo entre sin presión.",
  "Drain and let them steam dry in the colander for three minutes so the butter clings rather than slides.":
    "Escurra y déjelas secar al vapor en el colador por tres minutos para que la mantequilla se adhiera en vez de resbalar.",
  "Roll them in the huacatay butter while they are hot enough to melt it on contact.":
    "Ruédelas en la mantequilla de huacatay mientras estén lo bastante calientes para derretirla al contacto.",
  "Finish with Maras salt and parsley at the pass, not in the kitchen; the salt dissolves if it waits.":
    "Termine con sal de Maras y perejil en el pase, no en la cocina; la sal se disuelve si espera.",
  "Boil in the morning and hold at room temperature; roll in the butter at the venue. The butter itself keeps a week.":
    "Hierva en la mañana y manténgalas a temperatura ambiente; ruédelas en la mantequilla en el local. La mantequilla misma dura una semana.",
  "Ninety minutes warm. They are also good cold, which makes them one of the safest sides for a long buffet.":
    "Noventa minutos tibias. También son buenas frías, lo que las vuelve una de las guarniciones más seguras para un buffet largo.",
  "Papa nativa varies in size more than a commercial potato. Sort by size before boiling or half will be raw.":
    "La papa nativa varía más de tamaño que una papa comercial. Sepárelas por tamaño antes de hervir o la mitad quedará cruda.",

  // ---- 208 Barley Bannocks, Muna Butter ----
  "40 bannocks": "40 bannocks",
  "for the muña butter": "para la mantequilla de muña",
  "Rub the butter into both flours with the baking powder and salt until it looks like coarse meal.":
    "Arene la mantequilla con las dos harinas, el polvo de hornear y la sal hasta que parezca harina gruesa.",
  "Add buttermilk and bring it together with a knife. Handle it as little as you can bear; barley has no gluten to spare.":
    "Agregue el suero de leche y una la masa con un cuchillo. Manipúlela lo menos que soporte; la cebada no tiene gluten de sobra.",
  "Roll to 1.5 cm, cut 7 cm rounds, and rest them 15 minutes before they go on the heat.":
    "Estire a 1,5 cm, corte discos de 7 cm y déjelos reposar 15 minutos antes de llevarlos al fuego.",
  "Griddle on a dry plancha at a moderate heat for 5 minutes a side until they sound hollow and are speckled brown.":
    "Hágalos en plancha seca a fuego moderado 5 minutos por lado hasta que suenen huecos y estén moteados de dorado.",
  "Beat the muña and flaked salt into the second lot of butter and serve it soft alongside.":
    "Integre la muña y la sal en escamas a la segunda porción de mantequilla y sírvala blanda al lado.",
  "Best the day they are made. The dough can be cut and frozen raw for a month and griddled from frozen, slower.":
    "Mejores el día en que se hacen. La masa se puede cortar y congelar cruda por un mes y hacerse a la plancha desde congelada, más despacio.",
  "Two hours wrapped in a cloth, which is how a Scottish kitchen has always held them. In plastic they sweat.":
    "Dos horas envueltos en un paño, que es como una cocina escocesa los ha guardado siempre. En plástico transpiran.",
  "A plancha holds about twelve. Above 100 bannocks bake them at 220 °C instead, and say so on the sheet.":
    "Una plancha acepta unos doce. Por encima de 100 bannocks hornéelos a 220 °C, y déjelo dicho en la hoja.",

  // ---- 209 Partan Bree Bowl ----
  "brown and white; confirm the veda month before ordering":
    "carne oscura y blanca; confirme el mes de veda antes de hacer el pedido",
  "Roast the shells, then infuse them in the milk with onion for 30 minutes and strain twice through muslin.":
    "Tueste los caparazones, infusiónelos en la leche con cebolla por 30 minutos y cuele dos veces por gasa.",
  "Cook the rice into the crab milk until it falls apart — 25 minutes — then blitz and pass through a sieve.":
    "Cocine el arroz en la leche de cangrejo hasta que se deshaga — 25 minutos — luego licúe y pase por colador.",
  "Fold the brown meat in, blitz again, and finish with cream and white pepper until it coats a spoon.":
    "Integre la carne oscura, licúe otra vez y termine con crema y pimienta blanca hasta que nape la cuchara.",
  "Keep the white meat back and stir it through only when the bowls are going out, so it stays in strands.":
    "Reserve la carne blanca e incorpórela solo cuando salen los bowls, para que se mantenga en hebras.",
  "Blitz rocoto with olive oil, let it settle, and spoon the clear red oil over with blanched choclo and chives.":
    "Licúe rocoto con aceite de oliva, deje asentar y reparta el aceite rojo transparente encima con choclo blanqueado y cebollín.",
  "The base keeps 3 days chilled or a month frozen. Buy and pick the white meat on the day of the event.":
    "La base dura 3 días refrigerada o un mes congelada. Compre y desmenuce la carne blanca el día del evento.",
  "Two hours at 65 °C in a bain-marie. Over direct heat it catches and the whole batch tastes burnt.":
    "Dos horas a 65 °C en baño maría. A fuego directo se pega y toda la tanda sabe a quemado.",
  "Picking crab is the labour, not the soup: about 1 kg of meat an hour per person. Buy it picked if you can.":
    "Desmenuzar cangrejo es el trabajo, no la sopa: alrededor de 1 kg de carne por hora por persona. Cómprelo desmenuzado si puede.",

  // ---- 210 Barley & Kale Bowl, Aji Verde ----
  "peeled, 3 cm dice": "pelado, en cubos de 3 cm",
  "Rinse the barley until the water runs clear, then simmer it in the stock for 35 minutes until tender with a bite.":
    "Lave la cebada hasta que el agua salga clara y cocínela a fuego lento en el caldo por 35 minutos hasta que esté tierna con mordida.",
  "Roast the zapallo at 210 °C with oil and cumin for 25 minutes until the edges char. Steamed squash makes this dull.":
    "Hornee el zapallo a 210 °C con aceite y comino por 25 minutos hasta que los bordes se tuesten. El zapallo al vapor vuelve esto anodino.",
  "Sweat the onion soft and stir it through the drained barley while both are still warm.":
    "Sude la cebolla hasta ablandarla e intégrela a la cebada escurrida mientras ambas siguen tibias.",
  "Blanch the kale 2 minutes, squeeze it dry, chop it roughly and fold it in.":
    "Blanquee el kale 2 minutos, exprímalo, píquelo grueso e intégrelo.",
  "Blitz ají amarillo, coriander, lime juice and oil into a loose dressing and dress the bowl warm, not hot.":
    "Licúe ají amarillo, culantro, jugo de limón y aceite hasta un aderezo ligero y adere el bowl tibio, no caliente.",
  "Check the salt twice. Barley absorbs seasoning as it cools and a bowl that tasted right at noon will not at two.":
    "Revise la sal dos veces. La cebada absorbe la sazón al enfriar, y un bowl que sabía bien al mediodía no lo hará a las dos.",
  "All three components keep 3 days apart. Dress within an hour of service or the kale dulls and the lime deadens.":
    "Los tres componentes duran 3 días por separado. Adere dentro de la hora previa al servicio o el kale pierde color y el limón se apaga.",
  "Four hours cold, which makes it the safest vegan bowl here for a long drop-off.":
    "Cuatro horas en frío, lo que lo vuelve el bowl vegano más seguro de esta carta para una entrega larga.",
  "Roast the squash in single layers. Two trays deep and it steams, and the char is the whole flavour.":
    "Hornee el zapallo en una sola capa. Dos bandejas encimadas y se cocina al vapor, y el tostado es todo el sabor.",

  // ---- 211 Kippered Trout, Muna Butter ----
  "about 300 g each, butterflied through the back, heads left on":
    "de unos 300 g cada una, abiertas en mariposa por el lomo, con cabeza",
  "Brine the butterflied trout in salt and sugar for 90 minutes, then rinse and dry them on racks until tacky.":
    "Ponga las truchas abiertas en salmuera de sal y azúcar por 90 minutos, enjuáguelas y séquelas sobre rejillas hasta que queden pegajosas al tacto.",
  "Cold-smoke over oak or algarrobo for 3 hours. The skin should go bronze and the flesh stay raw to the touch.":
    "Ahúme en frío sobre roble o algarrobo por 3 horas. La piel debe volverse bronce y la carne seguir cruda al tacto.",
  "Beat muña, lemon zest and pepper into the softened butter and roll it in paper. Chill until firm, then slice into discs.":
    "Integre muña, ralladura de limón y pimienta a la mantequilla pomada y enróllela en papel. Refrigere hasta que esté firme y corte en discos.",
  "Grill skin-side down on the plancha for 4 minutes, then flip for barely one. It is thin and it overcooks in seconds.":
    "Ase con la piel hacia abajo en la plancha por 4 minutos y voltee apenas uno. Es delgada y se pasa en segundos.",
  "Put a disc of muña butter on as it comes off, with a lemon half on the side.":
    "Ponga un disco de mantequilla de muña al sacarla, con medio limón al lado.",
  "Brine and smoke the day before; smoked trout is better rested overnight. The butter keeps two weeks.":
    "Salmuere y ahúme el día anterior; la trucha ahumada está mejor reposada toda la noche. La mantequilla dura dos semanas.",
  "Cooked to order at the station and eaten in minutes. It does not hold at all, which is why it is a live station.":
    "Se cocina al momento en la estación y se come en minutos. No aguanta nada, y por eso es estación en vivo.",
  "The plancha takes six at a time. Above 60 covers you need a second plancha, not a bigger one.":
    "La plancha acepta seis a la vez. Por encima de 60 cubiertos necesita una segunda plancha, no una más grande.",

  // ---- 212 Aguaymanto Brose ----
  "or water for a plainer, older version": "o agua, para una versión más simple y más antigua",
  "half left whole, half crushed with sugar":
    "la mitad entero, la mitad aplastado con azúcar",
  "Toast the pinhead oatmeal dry until it smells of biscuit and let it cool completely before anything wet touches it.":
    "Tueste la avena entera en seco hasta que huela a galleta y déjela enfriar por completo antes de que le toque nada húmedo.",
  "Stir the oatmeal into the milk with the salt and leave it covered overnight in the fridge. No heat, ever — that is what brose is.":
    "Integre la avena a la leche con la sal y déjela tapada toda la noche en la refrigeradora. Nada de calor, nunca — eso es un brose.",
  "Crush half the aguaymanto with a little honey and leave it to weep into a syrup.":
    "Aplaste la mitad del aguaymanto con un poco de miel y déjelo soltar su jugo hasta formar un almíbar.",
  "In the morning loosen the brose with more milk; it thickens far more overnight than you expect.":
    "En la mañana afloje el brose con más leche; espesa mucho más durante la noche de lo que uno espera.",
  "Layer brose, aguaymanto syrup, cream and whole berries into pots and lid them.":
    "Arme por capas brose, almíbar de aguaymanto, crema y frutos enteros en potes y tápelos.",
  "Soak overnight, build in the morning, serve within 12 hours. Beyond that the oatmeal goes claggy and sour.":
    "Remoje toda la noche, arme en la mañana y sirva dentro de 12 horas. Más allá de eso la avena se apelmaza y agria.",
  "Four hours cold in a lidded pot. No reheating, no station, no equipment at the venue at all.":
    "Cuatro horas en frío en pote con tapa. Sin recalentar, sin estación y sin ningún equipo en el local.",
  "Soak in the containers the pots are portioned from. Decanting cold brose between vessels is a waste of an hour.":
    "Remoje en los mismos recipientes desde los que se porcionan los potes. Trasvasar brose frío entre envases es perder una hora.",

  // ---- 213 Cranachan Overnight Oats ----
  "seeded and scooped; the season is April to September":
    "sin pepas y en pulpa; la temporada va de abril a setiembre",
  "toasted, for the crunch on top": "tostada, para el crocante de encima",
  "Toast the pinhead oatmeal until dark gold. Keep it separate and dry; folded in early it goes soft by morning.":
    "Tueste la avena entera hasta un dorado oscuro. Manténgala aparte y seca; integrada antes de tiempo se ablanda para la mañana.",
  "Stir the rolled oats into the milk with half the honey and soak overnight, covered and cold.":
    "Integre la avena en hojuelas a la leche con la mitad de la miel y remoje toda la noche, tapada y en frío.",
  "Whip the cream to soft peaks with the rest of the honey — soft, not stiff, or it sits on top like a lid.":
    "Bata la crema a picos suaves con el resto de la miel — suave, no firme, o se queda encima como una tapa.",
  "Scoop the chirimoya at the last moment, picking out every seed, and dress it in lime juice to stop it browning.":
    "Saque la pulpa de la chirimoya al último momento, retirando todas las pepas, y báñela en jugo de limón para que no se oxide.",
  "Layer oats, chirimoya and cream in pots and send the toasted oatmeal in a separate twist of paper.":
    "Arme capas de avena, chirimoya y crema en potes y mande la avena tostada aparte en un papel torcido.",
  "Soak the night before and build on the morning of delivery. The chirimoya is what dates it, not the oats.":
    "Remoje la noche anterior y arme la mañana de la entrega. Lo que le pone fecha es la chirimoya, no la avena.",
  "Six hours cold. The whole design of it is that nothing needs heat, a station or a plate at the other end.":
    "Seis horas en frío. Todo su diseño consiste en que nada necesita calor, estación ni plato del otro lado.",
  "Chirimoya is the constraint, not the oats. Out of season this dish comes off the list rather than swapping the fruit.":
    "La restricción es la chirimoya, no la avena. Fuera de temporada este plato sale de la carta en vez de cambiarle la fruta.",

  // ---- 214 Malt Whisky Ice Cream, Chancaca ----
  "something peated; a soft malt disappears entirely":
    "uno turbado; un malta suave desaparece por completo",
  "Bring milk and cream to a bare simmer. Whisk yolks and sugar pale, temper, and cook to 82 °C stirring constantly.":
    "Lleve la leche y la crema a un hervor apenas perceptible. Bata las yemas con el azúcar hasta palidecer, atempere y cocine hasta 82 °C revolviendo sin parar.",
  "Strain the custard and chill it overnight. A rested custard churns finer and tastes less of egg.":
    "Cuele la crema inglesa y refrigérela toda la noche. Una crema reposada mantece más fino y sabe menos a huevo.",
  "Churn, and add the whisky in the last minute of churning only. Alcohol early stops the whole thing freezing.":
    "Mantéquelo, y agregue el whisky solo en el último minuto del mantecado. El alcohol agregado antes impide que congele.",
  "Freeze hard for four hours in shallow trays, which sets faster and scoops better than a deep tub.":
    "Congele bien por cuatro horas en bandejas bajas, que cuajan más rápido y se sirven mejor que un pote hondo.",
  "Melt chancaca with the water, butter and salt into a sauce that pours warm and sets sticky as it cools.":
    "Derrita la chancaca con el agua, la mantequilla y la sal hasta una salsa que se vierta tibia y cuaje pegajosa al enfriar.",
  "Churn up to two weeks ahead and hold at −18 °C. The chancaca sauce keeps a month chilled and reheats in a pan.":
    "Mantéquelo hasta dos semanas antes y consérvelo a −18 °C. La salsa de chancaca dura un mes refrigerada y se recalienta en una olla.",
  "Twenty minutes on a buffet in Lima, and less in summer. This needs a freezer at the venue or it does not go on the quote.":
    "Veinte minutos en un buffet limeño, y menos en verano. Esto exige un congelador en el local o no entra en la cotización.",
  "Churn capacity is the whole limit. Above 60 portions hire a second machine or change the dessert.":
    "La capacidad de la mantecadora es todo el límite. Por encima de 60 porciones alquile una segunda máquina o cambie de postre.",

  // ---- 215 Dundee Marmalade Pudding ----
  "Dundee cut, thick peel": "corte Dundee, cáscara gruesa",
  "juice and zest, to cut the marmalade": "jugo y ralladura, para cortar la mermelada",
  "to serve": "para servir",
  "Butter the basins hard and spoon 60 g of marmalade into the bottom of each before any batter goes in.":
    "Enmantequille bien los boles y ponga 60 g de mermelada en el fondo de cada uno antes de agregar nada de masa.",
  "Cream butter and sugar until genuinely pale, six or seven minutes, then add the eggs one at a time.":
    "Cremee la mantequilla y el azúcar hasta que palidezcan de verdad, seis o siete minutos, y agregue los huevos de a uno.",
  "Fold in the flour and mixed spice, then loosen with the milk and the naranja agria juice and zest.":
    "Integre la harina y la mezcla de especias, y afloje con la leche y el jugo y la ralladura de naranja agria.",
  "Fill the basins two-thirds, cover with pleated paper and foil, and tie them down properly.":
    "Llene los boles hasta dos tercios, cubra con papel plegado y papel aluminio, y átelos bien.",
  "Steam for two hours, topping the water up from the kettle so the pan never drops off the boil.":
    "Cocine al vapor dos horas, reponiendo agua hirviendo para que la olla nunca deje de hervir.",
  "Turn out onto the plate so the marmalade runs down the sides, and pour cream over at the table.":
    "Desmolde sobre el plato para que la mermelada corra por los costados, y sirva la crema en la mesa.",
  "Steam up to 5 days ahead and keep them in the basins. They reheat by steaming 25 minutes, and improve for the rest.":
    "Cocínelos al vapor hasta 5 días antes y guárdelos en sus boles. Se recalientan al vapor en 25 minutos, y mejoran con el reposo.",
  "An hour warm in the basin. Turned out they cool fast, so turn out at the pass and not before.":
    "Una hora tibios en el bol. Desmoldados enfrían rápido, así que desmolde en el pase y no antes.",
  "Steamer space, not oven space, is the limit. Above 24 basins steam in two sittings the day before.":
    "El límite es el espacio de vaporera, no el de horno. Por encima de 24 boles cocine en dos tandas el día anterior.",

  // ---- 216 Abernethy Biscuits, Anise ----
  "80 biscuits": "80 galletas",
  "cold, diced": "fría, en cubos",
  "lightly crushed; caraway if you can find it, but you will not":
    "ligeramente machacado; alcaravea si la consigue, pero no la va a conseguir",
  "Rub the cold butter into the flour, sugar, baking powder, salt and anise until it looks like fine breadcrumbs.":
    "Arene la mantequilla fría con la harina, el azúcar, el polvo de hornear, la sal y el anís hasta que parezca pan molido fino.",
  "Bind with the egg and just enough milk to bring it together. It should be firm, not soft — this is a biscuit, not a scone.":
    "Ligue con el huevo y la leche justa para unir la masa. Debe quedar firme, no blanda — esto es una galleta, no un scone.",
  "Rest the dough 30 minutes chilled, then roll to 5 mm and cut 6 cm rounds. Dock each one with a fork.":
    "Deje reposar la masa 30 minutos en frío, estire a 5 mm y corte discos de 6 cm. Pinche cada uno con tenedor.",
  "Bake at 180 °C for 13–15 minutes until pale gold at the edges and still blond in the middle.":
    "Hornee a 180 °C por 13–15 minutos hasta que estén dorados claros en los bordes y aún rubios al centro.",
  "Cool on the tray for five minutes before moving them, or they break at the dock marks.":
    "Enfríe sobre la bandeja cinco minutos antes de moverlas, o se rompen por las marcas del pinchado.",
  "The dough freezes a month, rolled and cut. Baked, they keep two weeks in a tin and are better after two days.":
    "La masa se congela un mes, ya estirada y cortada. Horneadas duran dos semanas en un tarro y están mejor a los dos días.",
  "Indefinitely in a sealed tin, which is exactly why this one is on the list for long drop-offs.":
    "Indefinidamente en tarro hermético, que es exactamente por lo que esta figura en la carta para entregas largas.",
  "Cheapest piece per unit on the whole sheet. Roll and cut in 3 kg batches; the dough does not mind waiting.":
    "La pieza más barata por unidad de toda la hoja. Estire y corte en tandas de 3 kg; a la masa no le molesta esperar.",

  // ---- 217 Paris Bun, Chancaca Sugar ----
  "40 buns": "40 bollos",
  "grated coarse, for the top": "rallada gruesa, para la superficie",
  "Mix flour, yeast, sugar and salt, then work in the eggs and warm milk to a soft dough and knead 10 minutes.":
    "Mezcle harina, levadura, azúcar y sal, incorpore los huevos y la leche tibia hasta una masa suave y amase 10 minutos.",
  "Add the softened butter in three additions and keep kneading until it is glossy and pulls off the bowl.":
    "Agregue la mantequilla pomada en tres adiciones y siga amasando hasta que brille y se despegue del bol.",
  "Prove until doubled, knock back, and divide into 90 g pieces rolled into flat ovals about 1 cm thick.":
    "Deje leudar hasta que doble, desgasifique y divida en piezas de 90 g formadas en óvalos planos de aproximadamente 1 cm.",
  "Prove again on trays for 40 minutes — they should spread outwards rather than up. A Paris bun is a flat bun.":
    "Deje leudar otra vez en bandejas por 40 minutos — deben extenderse hacia los lados y no hacia arriba. Un Paris bun es un bollo plano.",
  "Egg wash, scatter the grated chancaca thickly over the tops, and bake at 200 °C for 16–18 minutes.":
    "Pincele con huevo, esparza la chancaca rallada en capa gruesa sobre la superficie y hornee a 200 °C por 16–18 minutos.",
  "Freeze the shaped dough a month and prove from frozen overnight in the fridge. Baked they are a one-day product.":
    "Congele la masa ya formada por un mes y leúdela desde congelado toda la noche en la refrigeradora. Horneados son producto de un solo día.",
  "A day in a paper bag. In plastic the chancaca dissolves into a wet patch within a couple of hours.":
    "Un día en bolsa de papel. En plástico la chancaca se disuelve en una mancha húmeda en un par de horas.",
  "Chancaca burns faster than white sugar. Above two trays drop the oven to 190 °C and give them two minutes more.":
    "La chancaca se quema más rápido que el azúcar blanca. Por encima de dos bandejas baje el horno a 190 °C y deles dos minutos más.",

  // ---- 218 Sopa a la Minuta con Cebada ----
  "coarse; a fine mince disappears into the broth":
    "gruesa; una molida fina desaparece dentro del caldo",
  "Rinse the barley and simmer it separately in stock for 30 minutes. Cooked in the soup it makes the whole pot cloudy.":
    "Lave la cebada y cocínela aparte en caldo por 30 minutos. Cocida dentro de la sopa enturbia toda la olla.",
  "Brown the mince hard in a dry pan until it catches, then lift it out and keep the fat.":
    "Dore la carne molida con fuerza en sartén seca hasta que se pegue un poco, retírela y guarde la grasa.",
  "Sweat onion and carrot in that fat, add ají panca and oregano, and cook them out two minutes.":
    "Sude la cebolla y la zanahoria en esa grasa, agregue ají panca y orégano y cocínelos dos minutos.",
  "Add grated tomato and cook it down to a paste, then the stock, the mince and the diced potato.":
    "Agregue tomate rallado y cocínelo hasta una pasta, luego el caldo, la carne y la papa en cubos.",
  "Simmer 20 minutes, add the cooked barley and the milk, and bring it back gently without boiling.":
    "Cocine a fuego lento 20 minutos, agregue la cebada cocida y la leche, y vuelva a calentar con suavidad sin que hierva.",
  "Finish with parsley. Season late — the barley keeps drinking salt as it sits.":
    "Termine con perejil. Sazone tarde — la cebada sigue absorbiendo sal mientras reposa.",
  "Best made the day of service. Cook the barley and the base separately a day ahead and marry them at the venue.":
    "Mejor hecha el día del servicio. Cocine la cebada y la base por separado un día antes y júntelas en el local.",
  "Two hours in a bain-marie. Longer and the barley swells until it is a stew rather than a soup.":
    "Dos horas en baño maría. Más tiempo y la cebada hincha hasta convertirla en guiso y no en sopa.",
  "Barley roughly triples in volume. Measure the pot before you cook, not after.":
    "La cebada triplica su volumen más o menos. Mida la olla antes de cocinar, no después.",

  // ---- 219 Chupe de Cangrejo, Avena ----
  "check the veda month before you order; the planner blocks it in closed months":
    "revise el mes de veda antes de pedir; el planificador lo bloquea en los meses cerrados",
  "the Scottish move: oats where the chupe would use rice":
    "el giro escocés: avena donde el chupe usaría arroz",
  "poached, one per two bowls": "escalfados, uno por cada dos platos",
  "Roast the crab shells and infuse them in the milk with onion and garlic for 30 minutes, then strain twice.":
    "Tueste los caparazones de cangrejo e infusiónelos en la leche con cebolla y ajo por 30 minutos, y cuele dos veces.",
  "Fry the ají amarillo in oil until it darkens and smells sweet — the aderezo is the backbone of any chupe.":
    "Fría el ají amarillo en aceite hasta que oscurezca y huela dulce — el aderezo es la columna vertebral de cualquier chupe.",
  "Add the crab milk and the oats and simmer 20 minutes until the oats break down and thicken it.":
    "Agregue la leche de cangrejo y la avena y cocine a fuego lento 20 minutos hasta que la avena se deshaga y lo espese.",
  "Add the diced papa amarilla and the choclo and cook until the potato is just soft, no further.":
    "Agregue la papa amarilla en cubos y el choclo y cocine hasta que la papa esté apenas blanda, no más.",
  "Fold the crab meat and cream through off the heat, then the huacatay, which must never boil.":
    "Integre la carne de cangrejo y la crema fuera del fuego, y luego el huacatay, que nunca debe hervir.",
  "Serve with half a poached egg per bowl, which is how a chupe is finished in Lima and how it should stay.":
    "Sirva con medio huevo escalfado por plato, que es como se termina un chupe en Lima y como debe quedarse.",
  "The oat and crab-milk base keeps 2 days. Crab meat, egg and huacatay all go in on the day.":
    "La base de avena y leche de cangrejo dura 2 días. La carne de cangrejo, el huevo y el huacatay entran el mismo día.",
  "Ninety minutes at 65 °C. The oats keep thickening, so hold a jug of the crab milk back to loosen it.":
    "Noventa minutos a 65 °C. La avena sigue espesando, así que reserve una jarra de la leche de cangrejo para aligerarlo.",
  "Oats catch far more readily than rice. Above 10 litres use a bain-marie insert, never a direct flame.":
    "La avena se pega mucho más fácil que el arroz. Por encima de 10 litros use inserto de baño maría, nunca llama directa.",

  // ---- 220 Tamalito Verde, Mantequilla de Muna ----
  "40 tamalitos": "40 tamalitos",
  "kernels blitzed coarse; the husks kept for wrapping":
    "granos procesados grueso; guarde las pancas para envolver",
  "cut into 20 cm squares and passed over a flame to soften":
    "cortada en cuadrados de 20 cm y pasada por la llama para ablandarla",
  "Blitz the choclo coarse — grainy, not smooth. A smooth purée steams into something closer to a custard.":
    "Procese el choclo grueso — granuloso, no liso. Un puré liso se cocina al vapor y queda más cerca de un flan.",
  "Blitz the coriander and culantro with a little oil into a bright green paste and set it aside.":
    "Licúe el culantro y el cilantro con un poco de aceite hasta una pasta verde intensa y resérvela.",
  "Fry the onion and ají amarillo in the rest of the oil until sweet, then stir the choclo in and cook it 10 minutes.":
    "Fría la cebolla y el ají amarillo en el resto del aceite hasta que estén dulces, integre el choclo y cocine 10 minutos.",
  "Take it off the heat, fold the herb paste through, and season. It should be spoonable and hold a soft shape.":
    "Retire del fuego, integre la pasta de hierbas y sazone. Debe poder tomarse con cuchara y sostener una forma blanda.",
  "Spoon 60 g onto each softened leaf, fold into parcels, tie, and steam upright for 50 minutes.":
    "Ponga 60 g sobre cada hoja ablandada, arme los paquetitos, átelos y cocine al vapor de pie por 50 minutos.",
  "Beat muña and flaked salt into the butter and serve it soft alongside, the way a bannock is buttered.":
    "Integre muña y sal en escamas a la mantequilla y sírvala blanda al lado, como se unta un bannock.",
  "Wrap a day ahead and steam on the day, or steam ahead and re-steam 15 minutes. They freeze a month wrapped.":
    "Envuelva un día antes y cocine al vapor el mismo día, o cocínelos antes y vuelva a vaporizar 15 minutos. Se congelan un mes envueltos.",
  "Two hours warm in their leaves, which is the best insulation on the whole list. Unwrapped they dry in 20 minutes.":
    "Dos horas tibios dentro de sus hojas, el mejor aislante de toda la carta. Desenvueltos se secan en 20 minutos.",
  "Wrapping is the labour: about 50 an hour by hand. Two people from 100 parcels up.":
    "Envolver es el trabajo: unos 50 por hora a mano. Dos personas a partir de 100 paquetitos.",

  // ---- 221 Anticucho de Alpaca, Enebro ----
  "60 portions": "60 porciones",
  "loin or top of the leg, cut in 3 cm cubes":
    "lomo o parte alta de la pierna, en cubos de 3 cm",
  "crushed; the Scottish move, and it belongs with game":
    "machacadas; el giro escocés, y le queda bien a la carne de caza",
  "soaked an hour or they burn through on the grill":
    "remojados una hora o se queman en la parrilla",
  "Blitz ají panca, garlic, juniper, cumin, oregano, vinegar and oil into a marinade thick enough to cling.":
    "Licúe ají panca, ajo, enebro, comino, orégano, vinagre y aceite hasta un adobo lo bastante espeso para adherirse.",
  "Marinate the alpaca 6 hours, and no longer than 12 — the vinegar starts to cure lean meat past that.":
    "Macere la alpaca 6 horas, y no más de 12 — pasado ese punto el vinagre empieza a curar la carne magra.",
  "Thread three cubes per skewer, leaving a gap between each so the heat gets all the way round.":
    "Ensarte tres cubos por brocheta, dejando espacio entre cada uno para que el calor los rodee por completo.",
  "Grill hot and fast, 3 minutes a side, basting once with the reserved marinade boiled for two minutes first.":
    "Ase fuerte y rápido, 3 minutos por lado, bañando una vez con el adobo reservado hervido antes por dos minutos.",
  "Rest 2 minutes off the heat. Alpaca is lean enough that another minute on the grill is the difference between rare and grey.":
    "Repose 2 minutos fuera del fuego. La alpaca es tan magra que un minuto más en la parrilla es la diferencia entre jugosa y gris.",
  "Marinate and skewer the day before and keep them flat on trays. The marinade itself keeps a week chilled.":
    "Macere y ensarte el día anterior y manténgalas planas en bandejas. El adobo en sí dura una semana refrigerado.",
  "Grilled to order at the station. Ten minutes on a tray is the limit before they go from rare to leathery.":
    "Asadas al momento en la estación. Diez minutos en bandeja es el límite antes de que pasen de jugosas a correosas.",
  "A parrilla takes about 20 skewers. Above 120 portions you need a second grill and a second cook.":
    "Una parrilla acepta unas 20 brochetas. Por encima de 120 porciones necesita una segunda parrilla y un segundo cocinero.",

  // ---- 222 Salchicha Huachana con Avena ----
  "60 squares": "60 cuadrados",
  "coarse minced with its own fat": "molido grueso con su propia grasa",
  "toasted; the Lorne binding, in a Huacho sausage":
    "tostada; la ligazón del Lorne, dentro de una salchicha huachana",
  "ground; it is the colour a huachana has to be":
    "molido; es el color que una huachana tiene que tener",
  "Mix the achiote into a little warm oil first so it blooms; stirred in dry it stays speckled rather than colouring.":
    "Mezcle primero el achiote con un poco de aceite tibio para que se abra; agregado en seco queda moteado en vez de dar color.",
  "Work the mince with ají amarillo, achiote oil, garlic, cumin, pepper, vinegar and salt until it turns sticky.":
    "Trabaje la carne molida con ají amarillo, aceite de achiote, ajo, comino, pimienta, vinagre y sal hasta que se ponga pegajosa.",
  "Add the toasted oatmeal and the cold water and mix hard for two minutes. This is what makes it a Lorne square.":
    "Agregue la avena tostada y el agua fría y mezcle con fuerza dos minutos. Eso es lo que la convierte en un cuadrado tipo Lorne.",
  "Press into lined 5 cm-deep trays, cover, and chill overnight so it sets firm enough to cut.":
    "Presione en bandejas forradas de 5 cm de alto, tape y refrigere toda la noche para que cuaje lo bastante firme para cortarse.",
  "Turn out and cut into 5 cm squares 1.5 cm thick, then griddle on a hot plancha 3 minutes a side.":
    "Desmolde y corte en cuadrados de 5 cm y 1,5 cm de grosor, y hágalos en plancha caliente 3 minutos por lado.",
  "The set block keeps 3 days chilled and freezes a month. Cut squares freeze flat between sheets of paper.":
    "El bloque cuajado dura 3 días refrigerado y se congela un mes. Los cuadrados cortados se congelan planos entre hojas de papel.",
  "Cooked to order on the plancha and served straight off it. Held on a tray they weep fat and go greasy.":
    "Se cocinan al momento en la plancha y se sirven directo de ella. En espera sobre una bandeja sueltan grasa y quedan aceitosos.",
  "Chilling overnight is not optional at any scale. A warm block cuts into rubble instead of squares.":
    "Refrigerar toda la noche no es opcional a ninguna escala. Un bloque tibio se corta en escombros y no en cuadrados.",

  // ---- 223 Bizcocho de Quinua y Lucuma ----
  "for the buttercream; frozen pulp is fine and often better":
    "para el buttercream; la pulpa congelada sirve y a menudo es mejor",
  "for the buttercream": "para el buttercream",
  "Toast the quinoa flour dry in a low oven for 8 minutes. Untoasted it tastes green and slightly bitter in a sponge.":
    "Tueste la harina de quinua en seco en horno bajo por 8 minutos. Sin tostar sabe verde y algo amarga dentro de un bizcocho.",
  "Cream butter and sugar pale, then add the eggs one at a time with a spoon of the flour to stop it curdling.":
    "Cremee la mantequilla y el azúcar hasta que palidezcan y agregue los huevos de a uno con una cucharada de la harina para que no se corte.",
  "Fold in both flours, the baking powder and salt, then loosen with the milk to a slow dropping consistency.":
    "Integre las dos harinas, el polvo de hornear y la sal, y afloje con la leche hasta que caiga lentamente de la cuchara.",
  "Bake in two lined 23 cm tins at 175 °C for 40–45 minutes. Quinoa flour browns faster, so cover at 30 minutes.":
    "Hornee en dos moldes forrados de 23 cm a 175 °C por 40–45 minutos. La harina de quinua dora más rápido, así que cubra a los 30 minutos.",
  "Beat the lucuma pulp into the butter and icing sugar until it holds a peak, and fill and top the cooled cakes.":
    "Integre la pulpa de lúcuma a la mantequilla y el azúcar en polvo hasta que sostenga un pico, y rellene y cubra los bizcochos fríos.",
  "Chill an hour before slicing so the buttercream sets enough to cut clean edges.":
    "Refrigere una hora antes de cortar para que el buttercream cuaje lo suficiente y dé bordes limpios.",
  "The sponges keep 3 days wrapped or freeze a month. Fill on the day; lucuma buttercream weeps after 24 hours.":
    "Los bizcochos duran 3 días envueltos o se congelan un mes. Rellene el mismo día; el buttercream de lúcuma llora a las 24 horas.",
  "Six hours at room temperature, less in Lima's summer. The buttercream is the limit, not the sponge.":
    "Seis horas a temperatura ambiente, menos en el verano limeño. El límite es el buttercream, no el bizcocho.",
  "Denser than a wheat sponge, so it needs longer and lower. Never bake it above 175 °C to save time.":
    "Más denso que un bizcocho de trigo, así que necesita más tiempo y menos calor. Nunca lo hornee por encima de 175 °C para ahorrar tiempo.",
